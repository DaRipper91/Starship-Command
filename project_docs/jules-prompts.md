# Prompts for DaRipper and Gemini - Step-by-Step Development Guide

This document contains specific prompts you can give to DaRipper and Gemini (Google AI) to build each component of the Starship Theme Creator.
...
## Tips for Working with DaRipper and Gemini
...
3. **Provide context**: Remind DaRipper and Gemini of related code from previous prompts
...
6. **Test frequently**: Ask DaRipper and Gemini to suggest test cases for each feature
