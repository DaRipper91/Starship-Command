## GitHub Actions Workflows for DaRipper and Gemini Scheduled Tasks
...
name: "DaRipper and Gemini: Daily Security Scan"
on:
...
steps: - uses: google-labs-code/jules-invoke@v1
with:
...
name: "DaRipper and Gemini: Daily Dependency Check"
on:
...
name: "DaRipper and Gemini: Weekly Code Quality Audit"
on:
schedule: - cron: "0 3 \* \* 1" # Every Monday at 3:00 AM UTC
workflow_dispatch:
...
name: "DaRipper and Gemini: Weekly Performance Audit"
on:
schedule: - cron: "0 3 \* \* 3" # Every Wednesday at 3:00 AM UTC
workflow_dispatch:
...
name: "DaRipper and Gemini: Weekly Starship Compatibility Sync"
on:
schedule: - cron: "0 10 \* \* 0" # Every Sunday at 10:00 AM UTC
workflow_dispatch:
...
name: "DaRipper and Gemini: Implement GitHub Issue"
on:
issues:
types: [labeled]
...
jobs:
implement-issue: # Only runs when 'jules' label is added AND user is trusted
if: |
...
name: "DaRipper and Gemini: Monthly Deep Cleanup"
on:
schedule: - cron: "0 2 1 \* \*" # 1st of every month at 2:00 AM UTC
workflow_dispatch:
