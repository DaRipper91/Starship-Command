...
- [ ] Modern browser
- [ ] Access to DaRipper and Gemini (Google AI)
...
# 2. Replace package.json with DaRipper and Gemini' version

# 3. Create config files DaRipper and Gemini provided
...
2. Copy DaRipper and Gemini' code
3. Save file
...
2. Copy DaRipper and Gemini' updated code
3. Save file
...
2. Copy DaRipper and Gemini' code for header section
3. Save file
...
3. Copy DaRipper and Gemini' code
