    ...
    <div className="flex h-screen flex-col overflow-hidden bg-[#0d1117] font-sans text-gray-100">
      ...
      <header className="flex h-auto min-h-[4rem] shrink-0 flex-col border-b border-gray-800 bg-[#161b22] px-4 py-2 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-0">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-2 sm:mt-0 sm:justify-end">
          ...
          <button
            onClick={handleSave}
            className="flex items-center gap-2 rounded bg-blue-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
          >
          ...
          <div className="hidden gap-2 md:flex">
            <button
              ...
              className="flex items-center gap-2 rounded bg-indigo-600 px-3 py-1.5 text-sm font-medium hover:bg-indigo-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
            >
