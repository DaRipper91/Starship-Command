...
export class TomlParser {
  /**
   * Parses a TOML string into a configuration and metadata object
  ...
  /**
   * Converts a StarshipConfig object and metadata back to a TOML string
   * @param config - The configuration object
   * @param metadata - The theme metadata
   * @returns TOML string
   */
  static stringify(config: StarshipConfig, metadata?: ThemeMetadata): string {
    try {
