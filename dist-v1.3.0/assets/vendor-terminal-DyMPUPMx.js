            ...
            var te = {
                4567: function (I, r, a) {
                        ...
                        var m,
                          ...
                          g =
                            h < 3
                              ? o
                              : v === null
                                ? (v = Object.getOwnPropertyDescriptor(o, l))
                                : v;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          g = Reflect.decorate(i, o, l, v);
                        else
                          for (var b = i.length - 1; b >= 0; b--)
                            (m = i[b]) &&
                              (g =
                                (h < 3 ? m(g) : h > 3 ? m(o, l, g) : m(o, l)) ||
                                g);
                        return (
                          h > 3 && g && Object.defineProperty(o, l, g),
                          g
                        );
                      },
                    _ =
                  ...
                  const n = a(9042),
                    ...
                    e = a(4725),
                    s = a(3656);
                  let t = (r.AccessibilityManager = class extends p.Disposable {
                    constructor(i, o) {
                      (super(),
                        (this._terminal = i),
                      ...
                      for (let l = 0; l < this._terminal.rows; l++)
                        ((this._rowElements[l] =
                          ...
                          this._rowContainer.appendChild(this._rowElements[l]));
                      if (
                        ((this._topBoundaryFocusListener = (l) =>
                          this._handleBoundaryFocus(l, 0)),
                        (this._bottomBoundaryFocusListener = (l) =>
                          this._handleBoundaryFocus(l, 1)),
                        ...
                        (this._liveRegionDebouncer = this.register(
                          new f.TimeBasedDebouncer(this._renderRows.bind(this)),
                        )),
                      ...
                      (this._terminal.element.insertAdjacentElement(
                        ...
                        this.register(
                          this._terminal.onResize((l) =>
                            this._handleResize(l.rows),
                          ),
                        ),
                        this.register(
                          this._terminal.onRender((l) =>
                            this._refreshRows(l.start, l.end),
                          ),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._terminal.onA11yChar((l) => this._handleChar(l)),
                        ),
                        this.register(
...
`),
                        ...
                        this.register(
                          this._terminal.onA11yTab((l) => this._handleTab(l)),
                        ),
                        this.register(
                          this._terminal.onKey((l) => this._handleKey(l.key)),
                        ),
                        this.register(
                        ...
                        (this._screenDprMonitor = new u.ScreenDprMonitor(
                          window,
                        )),
                    ...
                    _handleChar(i) {
                      this._liveRegionLineCount < 21 &&
                        (this._charsToConsume.length > 0
                          ? this._charsToConsume.shift() !== i &&
                            (this._charsToAnnounce += i)
                          : (this._charsToAnnounce += i),
                        i ===
                          `
` &&
                    ...
                    _clearLiveRegion() {
                      ((this._liveRegion.textContent = ''),
                        (this._liveRegionLineCount = 0),
                        d.isMac && this._liveRegion.remove());
                    }
                    _handleKey(i) {
                      (this._clearLiveRegion(),
                        new RegExp('\\p{Control}', 'u').test(i) ||
                          this._charsToConsume.push(i));
                    }
                    _refreshRows(i, o) {
                    ...
                    _renderRows(i, o) {
                      const l = this._terminal.buffer,
                        v = l.lines.length.toString();
                      for (let m = i; m <= o; m++) {
                        const h = l.translateBufferLineToString(
                            l.ydisp + m,
                            !0,
                          ),
                          g = (l.ydisp + m + 1).toString(),
                          b = this._rowElements[m];
                        b &&
                          (h.length === 0
                            ? (b.innerText = ' ')
                            : (b.textContent = h),
                          b.setAttribute('aria-posinset', g),
                          b.setAttribute('aria-setsize', v));
                      }
                    ...
                    _handleBoundaryFocus(i, o) {
                      ...
                      if (
                        (o === 0
                          ? ((m = l),
                            (h = this._rowElements.pop()),
                            this._rowContainer.removeChild(h))
                          : ((m = this._rowElements.shift()),
                            (h = l),
                ...
                3614: (I, r) => {
                  ...
                  function _(d, f, p, u) {
                    ((d = c(
                      (d = a(d)),
                      p.decPrivateModes.bracketedPasteMode &&
                        u.rawOptions.ignoreBracketedPasteMode !== !0,
                    )),
                      p.triggerDataEvent(d, !0),
                      (f.value = ''));
                  }
                  function n(d, f, p) {
                    const u = p.getBoundingClientRect(),
                      e = d.clientX - u.left - 10,
                      s = d.clientY - u.top - 10;
                    ((f.style.width = '20px'),
                      (f.style.height = '20px'),
                      (f.style.left = `${e}px`),
                      (f.style.top = `${s}px`),
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.bracketTextForPaste = c),
                    (r.copyHandler = function (d, f) {
                      (d.clipboardData &&
                        d.clipboardData.setData('text/plain', f.selectionText),
                        d.preventDefault());
                    }),
                    (r.handlePasteEvent = function (d, f, p, u) {
                      (d.stopPropagation(),
                        d.clipboardData &&
                          _(d.clipboardData.getData('text/plain'), f, p, u));
                    }),
                    (r.paste = _),
                    (r.moveTextAreaUnderMouseCursor = n),
                    (r.rightClickHandler = function (d, f, p, u, e) {
                      (n(d, f, p),
                        e && u.rightClickSelect(d),
                        (f.value = u.selectionText),
                        f.select());
                    }));
                },
                7239: (I, r, a) => {
                ...
                3656: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.addDisposableDomListener = function (a, c, _, n) {
                ...
                6465: function (I, r, a) {
                  var c =
                      ...
                      function (e, s, t, i) {
                        ...
                        if (
                          ...
                          v = Reflect.decorate(e, s, t, i);
                        else
                          for (var m = e.length - 1; m >= 0; m--)
                            (o = e[m]) &&
                              (v =
                                (l < 3 ? o(v) : l > 3 ? o(s, t, v) : o(s, t)) ||
                                v);
                        return (
                          l > 3 && v && Object.defineProperty(s, t, v),
                          v
                        );
                      },
                    _ =
                  ...
                  const n = a(3656),
                    ...
                    f = a(844),
                    p = a(2585);
                  let u = (r.Linkifier2 = class extends f.Disposable {
                    get currentLink() {
                    ...
                    _askForLink(e, s) {
                      ...
                      let o = !1;
                      for (const [l, v] of this._linkProviders.entries())
                        s
                          ? !(
                              (i = this._activeProviderReplies) === null ||
                              i === void 0
                            ) &&
                            i.get(l) &&
                            (o = this._checkLinkProviderResult(l, e, o))
                          : v.provideLinks(e.y, (m) => {
                              var h, g;
                              if (this._isMouseOut) return;
                              const b = m?.map((L) => ({ link: L }));
                              ((h = this._activeProviderReplies) === null ||
                                h === void 0 ||
                                h.set(l, b),
                                (o = this._checkLinkProviderResult(l, e, o)),
                                ((g = this._activeProviderReplies) === null ||
                                g === void 0
                                  ? void 0
                                  : g.size) === this._linkProviders.length &&
                      ...
                      for (let i = 0; i < s.size; i++) {
                        ...
                        if (o)
                          for (let l = 0; l < o.length; l++) {
                            const v = o[l],
                              m =
                                v.link.range.start.y < e
                                  ? 0
                                  : v.link.range.start.x,
                              h =
                                v.link.range.end.y > e
                    ...
                    _checkLinkProviderResult(e, s, t) {
                      ...
                      if (
                        ...
                        for (
                          ...
                          const m =
                            (i = this._activeProviderReplies.get(v)) === null ||
                            i === void 0
                              ? void 0
                              : i.find((h) => this._linkAtPosition(h.link, s));
                          if (m) {
                        ...
                        Object.defineProperties(e.link.decorations, {
                          pointerCursor: {
                            get: () => {
                              var t, i;
                              return (i =
                                (t = this._currentLink) === null || t === void 0
                                  ? void 0
                                  : t.state) === null || i === void 0
                                ? void 0
                                : i.decorations.pointerCursor;
                            },
                            set: (t) => {
                              var i, o;
                              !(
                                (i = this._currentLink) === null || i === void 0
                              ) &&
                                i.state &&
                            ...
                            set: (t) => {
                              ...
                              !(
                                ...
                                ((l =
                                  ...
                                  o === void 0
                                    ? void 0
                                    : o.state) === null || l === void 0
                                  ? void 0
                                  : l.decorations.underline) !== t &&
                            ...
                            this._renderService.onRenderedViewportChange(
                              (t) => {
                                ...
                                if (
                                  ...
                                  this._currentLink.link.range.end.y <= o &&
                                  (this._clearCurrentLink(i, o),
                                  this._lastMouseEvent && this._element)
                                ) {
                                  const l = this._positionFromMouseEvent(
                                    this._lastMouseEvent,
                                    this._element,
                                    this._mouseService,
                                  );
                    ...
                    _linkHover(e, s, t) {
                      ...
                      (!((i = this._currentLink) === null || i === void 0) &&
                        ...
                        s.hover && s.hover(t, s.text));
                    }
                    _fireUnderlineEvent(e, s) {
                      const t = e.range,
                        i = this._bufferService.buffer.ydisp,
                        o = this._createLinkUnderlineEvent(
                          t.start.x - 1,
                          t.start.y - i - 1,
                          t.end.x,
                          t.end.y - i - 1,
                    ...
                    _linkAtPosition(e, s) {
                      const t =
                        ...
                        i =
                          ...
                          e.range.end.x,
                        o = s.y * this._bufferService.cols + s.x;
                      return t <= o && o <= i;
                    }
                  ...
                  r.Linkifier2 = u = c([_(0, p.IBufferService)], u);
                },
                9042: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                ...
                3730: function (I, r, a) {
                        ...
                        var i,
                          ...
                          l =
                            o < 3
                              ? e
                              : t === null
                                ? (t = Object.getOwnPropertyDescriptor(e, s))
                                : t;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          l = Reflect.decorate(u, e, s, t);
                        else
                          for (var v = u.length - 1; v >= 0; v--)
                            (i = u[v]) &&
                              (l =
                                (o < 3 ? i(l) : o > 3 ? i(e, s, l) : i(e, s)) ||
                                l);
                        return (
                          o > 3 && l && Object.defineProperty(e, s, l),
                          l
                        );
                      },
                    _ =
                  ...
                  let f = (r.OscLinkProvider = class {
                    ...
                    provideLinks(u, e) {
                      ...
                      const i = [],
                        ...
                        l = new n.CellData(),
                        v = t.getTrimmedLength();
                      let m = -1,
                        h = -1,
                        g = !1;
                      for (let b = 0; b < v; b++)
                        if (h !== -1 || t.hasContent(b)) {
                          if (
                            (t.loadCell(b, l),
                            l.hasExtendedAttrs() && l.extended.urlId)
                          ) {
                            if (h === -1) {
                              ((h = b), (m = l.extended.urlId));
                              continue;
                            }
                            g = l.extended.urlId !== m;
                          } else h !== -1 && (g = !0);
                          if (g || (h !== -1 && b === v - 1)) {
                            const L =
                              (s = this._oscLinkService.getLinkData(m)) ===
                                null || s === void 0
                                ? void 0
                                : s.uri;
                            if (L) {
                              ...
                              let k = !1;
                              if (!o?.allowNonHttpProtocols)
                                try {
                                  const x = new URL(L);
                                  ['http:', 'https:'].includes(x.protocol) ||
                                    (k = !0);
                                } catch {
                                  k = !0;
                                }
                              k ||
                                i.push({
                                  ...
                                  range: y,
                                  activate: (x, T) =>
                                    o ? o.activate(x, T, y) : p(0, T),
                                  hover: (x, T) => {
                                    var O;
                                    return (O = o?.hover) === null ||
                                      O === void 0
                                      ? void 0
                                      : O.call(o, x, T, y);
                                  },
                  ...
                  function p(u, e) {
                    if (
                      confirm(`Do you want to navigate to ${e}?
...
WARNING: This link could potentially be dangerous`)
                ...
                5596: (I, r, a) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.ScreenDprMonitor = void 0));
                  const c = a(844);
                  class _ extends c.Disposable {
                    constructor(d) {
                      (super(),
                        (this._parentWindow = d),
                    ...
                    _updateDpr() {
                      var d;
                      this._outerListener &&
                        ((d = this._resolutionMediaMatchList) === null ||
                          d === void 0 ||
                          d.removeListener(this._outerListener),
                        (this._currentDevicePixelRatio =
                          this._parentWindow.devicePixelRatio),
                ...
                3236: (I, r, a) => {
                  ...
                  const c = a(3614),
                    ...
                    P = a(5435),
                    H = a(4567),
                    U = typeof window < 'u' ? window.document : null;
                  class W extends y.CoreTerminal {
                    ...
                    constructor(S = {}) {
                      (super(S),
                        ...
                        (this._accessibilityManager = this.register(
                          new x.MutableDisposable(),
                        )),
                        (this._onCursorMove = this.register(
                          new k.EventEmitter(),
                        )),
                        (this.onCursorMove = this._onCursorMove.event),
                        (this._onKey = this.register(new k.EventEmitter())),
                        (this.onKey = this._onKey.event),
                        (this._onRender = this.register(new k.EventEmitter())),
                        ...
                        (this._onBell = this.register(new k.EventEmitter())),
                        (this.onBell = this._onBell.event),
                        (this._onFocus = this.register(new k.EventEmitter())),
                        (this._onBlur = this.register(new k.EventEmitter())),
                        ...
                        this.register(
                          this._inputHandler.onRequestRefreshRows((R, B) =>
                            this.refresh(R, B),
                          ),
                        ),
                        this.register(
                        ...
                        this.register(
                          this._inputHandler.onRequestWindowsOptionsReport(
                            (R) => this._reportWindowsOptions(R),
                          ),
                        ),
                        this.register(
                          this._inputHandler.onColor((R) =>
                            this._handleColorEvent(R),
                          ),
                        ),
                        this.register(
                          (0, k.forwardEvent)(
                        ...
                        this.register(
                          this._bufferService.onResize((R) =>
                            this._afterResize(R.cols, R.rows),
                          ),
                        ),
                        this.register(
                          (0, x.toDisposable)(() => {
                    ...
                    _handleColorEvent(S) {
                      if (this._themeService)
                        for (const R of S) {
                          ...
                          switch (R.type) {
                            case 0:
                              const N = L.color.toColorRGB(
                                B === 'ansi'
                                  ? this._themeService.colors.ansi[R.index]
                                  : this._themeService.colors[B],
                              );
                              this.coreService.triggerDataEvent(
                                `${M.C0.ESC}]${A};${(0, w.toRgbString)(N)}${M.C1_ESCAPED.ST}`,
                              );
                              break;
                            case 1:
                              if (B === 'ansi')
                    ...
                    _handleTextAreaFocus(S) {
                      (this.coreService.decPrivateModes.sendFocus &&
                        this.coreService.triggerDataEvent(M.C0.ESC + '[I'),
                        this.updateCursorStyle(S),
                    ...
                    blur() {
                      var S;
                      return (S = this.textarea) === null || S === void 0
                        ? void 0
                        : S.blur();
                    }
                    _handleTextAreaBlur() {
                      ((this.textarea.value = ''),
                        ...
                        this.coreService.decPrivateModes.sendFocus &&
                          this.coreService.triggerDataEvent(M.C0.ESC + '[O'),
                    ...
                    _syncTextArea() {
                      if (
                        ...
                        return;
                      const S = this.buffer.ybase + this.buffer.y,
                        R = this.buffer.lines.get(S);
                      if (!R) return;
                      const B = Math.min(this.buffer.x, this.cols - 1),
                        A = this._renderService.dimensions.css.cell.height,
                        N = R.getWidth(B),
                        F = this._renderService.dimensions.css.cell.width * N,
                        j =
                          this.buffer.y *
                          this._renderService.dimensions.css.cell.height,
                        V = B * this._renderService.dimensions.css.cell.width;
                      ((this.textarea.style.left = V + 'px'),
                        (this.textarea.style.top = j + 'px'),
                      ...
                      (this._bindKeys(),
                        this.register(
                          (0, _.addDisposableDomListener)(
                            ...
                            (R) => {
                              this.hasSelection() &&
                                (0, c.copyHandler)(R, this._selectionService);
                            },
                          ),
                        ));
                      const S = (R) =>
                        ...
                        T.isLinux &&
                          this.register(
                            (0, _.addDisposableDomListener)(
                              ...
                              (R) => {
                                R.button === 1 &&
                                  (0, c.moveTextAreaUnderMouseCursor)(
                                    R,
                                    this.textarea,
                                    this.screenElement,
                                  );
                      ...
                      (this.register(
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(
                            this.textarea,
                            'compositionupdate',
                            (S) => this._compositionHelper.compositionupdate(S),
                          ),
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(
                    ...
                    open(S) {
                      ...
                      ((this._viewportElement = U.createElement('div')),
                        ...
                        B.appendChild(this._viewportElement),
                        ...
                        B.appendChild(this.screenElement),
                        ...
                        (this._coreBrowserService =
                          this._instantiationService.createInstance(
                            l.CoreBrowserService,
                            this.textarea,
                            (R = this._document.defaultView) !== null &&
                              R !== void 0
                              ? R
                              : window,
                          )),
                        this._instantiationService.setService(
                          g.ICoreBrowserService,
                          this._coreBrowserService,
                        ),
                        this.register(
                          (0, _.addDisposableDomListener)(
                        ...
                        this.onResize((A) =>
                          this._renderService.resize(A.cols, A.rows),
                        ),
                      ...
                      (this._renderService.hasRenderer() ||
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(
                            this.element,
                            'mousedown',
                            (A) => this._selectionService.handleMouseDown(A),
                          ),
                        ),
                    ...
                    bindMouse() {
                      const S = this,
                        R = this.element;
                      function B(F) {
                        const j = S._mouseService.getMouseReportCoords(
                          F,
                          S.screenElement,
                        );
                        if (!j) return !1;
                        ...
                        switch (F.overrideType || F.type) {
                          case 'mousemove':
                            ...
                            break;
                          case 'mouseup':
                            ((G = 0), (V = F.button < 3 ? F.button : 3));
                            break;
                          case 'mousedown':
                            ((G = 1), (V = F.button < 3 ? F.button : 3));
                            break;
                          case 'wheel':
                            if (S.viewport.getLinesScrolled(F) === 0) return !1;
                            ((G = F.deltaY < 0 ? 0 : 1), (V = 4));
                            break;
                          default:
                            return !1;
                        }
                        return (
                          !(G === void 0 || V === void 0 || V > 4) &&
                          S.coreMouseService.triggerMouseEvent({
                            col: j.col,
                            row: j.row,
                            x: j.x,
                            y: j.y,
                      ...
                      (this.register(
                        this.coreMouseService.onProtocolChange((F) => {
                          (F
                            ...
                            8 & F
                              ? A.mousemove ||
                                (R.addEventListener('mousemove', N.mousemove),
                                (A.mousemove = N.mousemove))
                            ...
                            16 & F
                              ? A.wheel ||
                                (R.addEventListener('wheel', N.wheel, {
                                  passive: !1,
                                }),
                                (A.wheel = N.wheel))
                              : (R.removeEventListener('wheel', A.wheel),
                                (A.wheel = null)),
                            2 & F
                              ? A.mouseup ||
                                (R.addEventListener('mouseup', N.mouseup),
                                (A.mouseup = N.mouseup))
                              : (this._document.removeEventListener(
                                  'mouseup',
                                  A.mouseup,
                                ),
                                R.removeEventListener('mouseup', A.mouseup),
                                (A.mouseup = null)),
                            4 & F
                              ? A.mousedrag || (A.mousedrag = N.mousedrag)
                              : (this._document.removeEventListener(
                                  'mousemove',
                                  A.mousedrag,
                                ),
                            ...
                            (F) => {
                              if (!A.wheel) {
                                if (!this.buffer.hasScrollback) {
                                  const j = this.viewport.getLinesScrolled(F);
                                  if (j === 0) return;
                                  const V =
                                    M.C0.ESC +
                                  ...
                                  for (let ie = 0; ie < Math.abs(j); ie++)
                                    G += V;
                                  return (
                                    this.coreService.triggerDataEvent(G, !0),
                                    this.cancel(F, !0)
                                  );
                                }
                                return this.viewport.handleWheel(F)
                                  ? this.cancel(F)
                                  : void 0;
                              }
                            },
                          ...
                          (0, _.addDisposableDomListener)(
                            ...
                            (F) => {
                              if (!this.coreMouseService.areMouseEventsActive)
                                return (
                                  this.viewport.handleTouchStart(F),
                                  this.cancel(F)
                                );
                            },
                            { passive: !0 },
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(
                            ...
                            (F) => {
                              if (!this.coreMouseService.areMouseEventsActive)
                                return this.viewport.handleTouchMove(F)
                                  ? void 0
                                  : this.cancel(F);
                            },
                            { passive: !1 },
                    ...
                    updateCursorStyle(S) {
                      var R;
                      !(
                        (R = this._selectionService) === null || R === void 0
                      ) && R.shouldColumnSelect(S)
                    ...
                    deregisterCharacterJoiner(S) {
                      if (!this._characterJoinerService)
                        throw new Error('Terminal must be opened first');
                      this._characterJoinerService.deregister(S) &&
                        this.refresh(0, this.rows - 1);
                    }
                    get markers() {
                    ...
                    registerMarker(S) {
                      return this.buffer.addMarker(
                        this.buffer.ybase + this.buffer.y + S,
                      );
                    }
                    ...
                    select(S, R, B) {
                      this._selectionService.setSelection(S, R, B);
                    }
                    getSelection() {
                    ...
                    _keyDown(S) {
                      if (
                        ...
                        this._customKeyEventHandler &&
                          this._customKeyEventHandler(S) === !1)
                      )
                        return !1;
                      const R =
                        this.browser.isMac &&
                        ...
                        S.altKey;
                      if (!R && !this._compositionHelper.keydown(S))
                        return (
                      ...
                      R ||
                        (S.key !== 'Dead' && S.key !== 'AltGraph') ||
                        (this._unprocessedDeadKey = !0);
                      const B = (0, C.evaluateKeyboardEvent)(
                        S,
                      ...
                      if (
                        ...
                        const A = this.rows - 1;
                        return (
                          this.scrollLines(B.type === 2 ? -A : A),
                          this.cancel(S, !0)
                        );
                      }
                      return (
                        B.type === 1 && this.selectAll(),
                        !!this._isThirdLevelShift(this.browser, S) ||
                          (B.cancel && this.cancel(S, !0),
                          !B.key ||
                            !!(
                              S.key &&
                              !S.ctrlKey &&
                              ...
                              !S.metaKey &&
                              S.key.length === 1 &&
                              S.key.charCodeAt(0) >= 65 &&
                              S.key.charCodeAt(0) <= 90
                            ) ||
                            (this._unprocessedDeadKey
                              ? ((this._unprocessedDeadKey = !1), !0)
                              : ((B.key !== M.C0.ETX && B.key !== M.C0.CR) ||
                                  (this.textarea.value = ''),
                                this._onKey.fire({ key: B.key, domEvent: S }),
                                this._showCursor(),
                                this.coreService.triggerDataEvent(B.key, !0),
                    ...
                    _isThirdLevelShift(S, R) {
                      const B =
                        (S.isMac &&
                          ...
                          !R.ctrlKey &&
                          !R.metaKey) ||
                        (S.isWindows && R.altKey && R.ctrlKey && !R.metaKey) ||
                        (S.isWindows && R.getModifierState('AltGraph'));
                      return R.type === 'keypress'
                        ? B
                        : B && (!R.keyCode || R.keyCode > 47);
                    }
                    _keyUp(S) {
                      ((this._keyDownSeen = !1),
                        (this._customKeyEventHandler &&
                    ...
                    _keyPress(S) {
                      ...
                      else if (S.which === null || S.which === void 0)
                        R = S.keyCode;
                      else {
                      ...
                      return !(
                        !R ||
                        ((S.altKey || S.ctrlKey || S.metaKey) &&
                          !this._isThirdLevelShift(this.browser, S)) ||
                        ((R = String.fromCharCode(R)),
                        this._onKey.fire({ key: R, domEvent: S }),
                        this._showCursor(),
                      ...
                      if (this.buffer.ybase !== 0 || this.buffer.y !== 0) {
                        ...
                        for (let R = 1; R < this.rows; R++)
                          this.buffer.lines.push(
                            this.buffer.getBlankLine(O.DEFAULT_ATTR_DATA),
                          );
                        (this._onScroll.fire({
                          position: this.buffer.ydisp,
                          source: 0,
                        }),
                          (S = this.viewport) === null ||
                            S === void 0 ||
                            S.reset(),
                          this.refresh(0, this.rows - 1));
                      }
                ...
                1680: function (I, r, a) {
                  var c =
                      ...
                      function (s, t, i, o) {
                        ...
                        if (
                          ...
                          m = Reflect.decorate(s, t, i, o);
                        else
                          for (var h = s.length - 1; h >= 0; h--)
                            (l = s[h]) &&
                              (m =
                                (v < 3 ? l(m) : v > 3 ? l(t, i, m) : l(t, i)) ||
                                m);
                        return (
                          v > 3 && m && Object.defineProperty(t, i, m),
                          m
                        );
                      },
                    _ =
                  ...
                  const n = a(3656),
                    ...
                    p = a(844),
                    u = a(2585);
                  let e = (r.Viewport = class extends p.Disposable {
                    constructor(s, t, i, o, l, v, m, h) {
                      (super(),
                        (this._viewportElement = s),
                        (this._scrollArea = t),
                        (this._bufferService = i),
                        (this._optionsService = o),
                        (this._charSizeService = l),
                        ...
                        this.register(
                          this._bufferService.buffers.onBufferActivate(
                            (g) => (this._activeBuffer = g.activeBuffer),
                          ),
                        ),
                        ...
                        this.register(
                          this._renderService.onDimensionsChange(
                            (g) => (this._renderDimensions = g),
                          ),
                        ),
                        this._handleThemeChange(h.colors),
                        this.register(
                          h.onChangeColors((g) => this._handleThemeChange(g)),
                        ),
                        this.register(
                    ...
                    _innerRefresh() {
                      if (this._charSizeService.height > 0) {
                        ...
                        this._lastRecordedBufferHeight !== t &&
                          ((this._lastRecordedBufferHeight = t),
                    ...
                    getBufferElements(s, t) {
                      ...
                      let o,
                        l = '';
                      const v = [],
                        m = t ?? this._bufferService.buffer.lines.length,
                        h = this._bufferService.buffer.lines;
                      for (let g = s; g < m; g++) {
                        const b = h.get(g);
                        if (!b) continue;
                        const L =
                          (i = h.get(g + 1)) === null || i === void 0
                            ? void 0
                            : i.isWrapped;
                        if (
                          ((l += b.translateToString(!L)),
                          !L || g === h.length - 1)
                        ) {
                  ...
                  r.Viewport = e = c(
                    [
                      _(2, u.IBufferService),
                      _(3, u.IOptionsService),
                ...
                3107: function (I, r, a) {
                  ...
                  const n = a(3656),
                    ...
                    f = a(844),
                    p = a(2585);
                  let u = (r.BufferDecorationRenderer = class extends (
                    f.Disposable
                  ) {
                    constructor(e, s, t, i) {
                      (super(),
                    ...
                    _createElement(e) {
                      ...
                      (i.classList.add('xterm-decoration'),
                        ...
                        (i.style.width = `${Math.round((e.options.width || 1) * this._renderService.dimensions.css.cell.width)}px`),
                        (i.style.height =
                          (e.options.height || 1) *
                            this._renderService.dimensions.css.cell.height +
                          'px'),
                      ...
                      const o =
                        (t = e.options.x) !== null && t !== void 0 ? t : 0;
                      return (
                        o &&
                    ...
                    _refreshStyle(e) {
                      ...
                      if (s < 0 || s >= this._bufferService.rows)
                        ...
                        (t ||
                          ((t = this._createElement(e)),
                          (e.element = t),
                          this._decorationElements.set(e, t),
                          ...
                          (t.style.top =
                            ...
                            'px'),
                          (t.style.display = this._altBufferIsActive
                            ? 'none'
                            : 'block'),
                          e.onRenderEmitter.fire(t));
                      }
                    }
                    ...
                    _removeDecoration(e) {
                      var s;
                      ((s = this._decorationElements.get(e)) === null ||
                        s === void 0 ||
                        s.remove(),
                  ...
                  r.BufferDecorationRenderer = u = c(
                    [
                      _(1, p.IBufferService),
                      _(2, p.IDecorationService),
                      _(3, d.IRenderService),
                    ],
                    u,
                  );
                },
                    ...
                    (r.ColorZoneStore = class {
                        ...
                        if (a.options.overviewRulerOptions) {
                          for (const c of this._zones)
                            if (
                              ...
                              if (this._lineIntersectsZone(c, a.marker.line))
                                return;
                              if (
                      ...
                      _lineAdjacentToZone(a, c, _) {
                        return (
                          ...
                          c <= a.endBufferLine + this._linePadding[_ || 'full']
                        );
                      }
                      _addLineToZone(a, c) {
                        ((a.startBufferLine = Math.min(a.startBufferLine, c)),
                          (a.endBufferLine = Math.max(a.endBufferLine, c)));
                      }
                    }));
                },
                5744: function (I, r, a) {
                        ...
                        var h,
                          ...
                          b =
                            g < 3
                              ? l
                              : m === null
                                ? (m = Object.getOwnPropertyDescriptor(l, v))
                                : m;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          b = Reflect.decorate(o, l, v, m);
                        else
                          for (var L = o.length - 1; L >= 0; L--)
                            (h = o[L]) &&
                              (b =
                                (g < 3 ? h(b) : g > 3 ? h(l, v, b) : h(l, v)) ||
                                b);
                        return (
                          g > 3 && b && Object.defineProperty(l, v, b),
                          b
                        );
                      },
                    _ =
                  ...
                  const n = a(5871),
                    ...
                    p = a(844),
                    u = a(2585),
                    e = { full: 0, left: 0, center: 0, right: 0 },
                    s = { full: 0, left: 0, center: 0, right: 0 },
                    t = { full: 0, left: 0, center: 0, right: 0 };
                  let i = (r.OverviewRulerRenderer = class extends (
                    p.Disposable
                  ) {
                    get _width() {
                      return (
                    ...
                    constructor(o, l, v, m, h, g, b) {
                      ...
                      (super(),
                        ...
                        (L = this._viewportElement.parentElement) === null ||
                          L === void 0 ||
                    ...
                    _refreshDrawConstants() {
                      const o = Math.floor(this._canvas.width / 3),
                        l = Math.ceil(this._canvas.width / 3);
                    ...
                    _refreshDecorations() {
                      ...
                      for (const l of o)
                        l.position !== 'full' && this._renderColorZone(l);
                      for (const l of o)
                        l.position === 'full' && this._renderColorZone(l);
                  ...
                  r.OverviewRulerRenderer = i = c(
                    [
                      _(2, u.IBufferService),
                      _(3, u.IDecorationService),
                      _(4, f.IRenderService),
                      _(5, u.IOptionsService),
                      _(6, f.ICoreBrowserService),
                    ],
                    i,
                  );
                },
                2950: function (I, r, a) {
                  ...
                  let p = (r.CompositionHelper = class {
                    ...
                    compositionupdate(u) {
                      ((this._compositionView.textContent = u.data),
                      ...
                      if (this._isComposing) {
                        if (this._bufferService.buffer.isCursorInViewport) {
                          ...
                          ((this._compositionView.style.left = i + 'px'),
                            (this._compositionView.style.top = t + 'px'),
                ...
                9806: (I, r) => {
                  function a(c, _, n) {
                    const d = n.getBoundingClientRect(),
                      f = c.getComputedStyle(n),
                      p = parseInt(f.getPropertyValue('padding-left')),
                      u = parseInt(f.getPropertyValue('padding-top'));
                    return [_.clientX - d.left - p, _.clientY - d.top - u];
                  }
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.getCoords = r.getCoordsRelativeToElement = void 0),
                    (r.getCoordsRelativeToElement = a),
                    (r.getCoords = function (c, _, n, d, f, p, u, e, s) {
                      if (!p) return;
                      const t = a(c, _, n);
                      return t
                        ? ((t[0] = Math.ceil((t[0] + (s ? u / 2 : 0)) / u)),
                          (t[1] = Math.ceil(t[1] / e)),
                          (t[0] = Math.min(Math.max(t[0], 1), d + (s ? 1 : 0))),
                          (t[1] = Math.min(Math.max(t[1], 1), f)),
                          t)
                        : void 0;
                    }));
                },
                9504: (I, r, a) => {
                    ...
                    const o = e - n(e, t),
                      ...
                      v =
                        ...
                        (function (m, h, g) {
                          ...
                          const L = m - n(m, g),
                            y = h - n(h, g);
                          for (let k = 0; k < Math.abs(L - y); k++) {
                            const x = d(m, h) === 'A' ? -1 : 1,
                              T = g.buffer.lines.get(L + x * k);
                            T?.isWrapped && b++;
                          }
                          return b;
                        })(e, s, t);
                    return u(v, p(d(e, s), i));
                  }
                  function n(e, s) {
                    let t = 0,
                      i = s.buffer.lines.get(e),
                      o = i?.isWrapped;
                    for (; o && e >= 0 && e < s.rows; )
                      (t++, (i = s.buffer.lines.get(--e)), (o = i?.isWrapped));
                    return t;
                  }
                  function d(e, s) {
                    return e > s ? 'A' : 'B';
                  }
                  function f(e, s, t, i, o, l) {
                    let v = e,
                      m = s,
                      h = '';
                    for (; v !== t || m !== i; )
                      ((v += o ? 1 : -1),
                        o && v > l.cols - 1
                          ? ((h += l.buffer.translateBufferLineToString(
                              m,
                              !1,
                              e,
                              v,
                          ...
                          : !o &&
                            ...
                            m--));
                    return (
                      h + l.buffer.translateBufferLineToString(m, !1, e, v)
                    );
                  }
                  function p(e, s) {
                    const t = s ? 'O' : '[';
                  ...
                  r.moveToCellSequence = function (e, s, t, i) {
                    ...
                    if (!t.buffer.hasScrollback)
                      return (
                        (function (h, g, b, L, y, k) {
                          return _(g, L, y, k).length === 0
                            ? ''
                            : u(
                                f(h, g, h, g - n(g, y), !1, y).length,
                                p('D', k),
                              );
                        })(o, l, 0, s, t, i) +
                        _(l, s, t, i) +
                        (function (h, g, b, L, y, k) {
                          let x;
                          x = _(g, L, y, k).length > 0 ? L - n(L, y) : g;
                          const T = L,
                            O = (function (M, C, w, E, D, P) {
                              let H;
                              return (
                                (H =
                                  _(w, E, D, P).length > 0 ? E - n(E, D) : C),
                                (M < w && H <= E) || (M >= w && H < E)
                                  ? 'C'
                                  : 'D'
                              );
                            })(h, g, b, L, y, k);
                          return u(f(h, x, b, T, O === 'C', y).length, p(O, k));
                        })(o, l, e, s, t, i)
                      );
                    let v;
                    if (l === s)
                ...
                1296: function (I, r, a) {
                        ...
                        var O,
                          ...
                          C =
                            M < 3
                              ? k
                              : T === null
                                ? (T = Object.getOwnPropertyDescriptor(k, x))
                                : T;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          C = Reflect.decorate(y, k, x, T);
                        else
                          for (var w = y.length - 1; w >= 0; w--)
                            (O = y[w]) &&
                              (C =
                                (M < 3 ? O(C) : M > 3 ? O(k, x, C) : O(k, x)) ||
                                C);
                        return (
                          M > 3 && C && Object.defineProperty(k, x, C),
                          C
                        );
                      },
                    _ =
                  ...
                  let b = 1,
                    L = (r.DomRenderer = class extends t.Disposable {
                      constructor(y, k, x, T, O, M, C, w, E, D) {
                        (super(),
                          (this._element = y),
                          (this._screenElement = k),
                          (this._viewportElement = x),
                          (this._linkifier2 = T),
                          ...
                          (this._selectionContainer =
                            document.createElement('div')),
                          this._selectionContainer.classList.add(g),
                          this._selectionContainer.setAttribute(
                            'aria-hidden',
                            'true',
                          ),
                          (this.dimensions = (0, p.createRenderDimensions)()),
                          ...
                          this.register(
                            this._themeService.onChangeColors((P) =>
                              this._injectCss(P),
                            ),
                          ),
                          this._injectCss(this._themeService.colors),
                          (this._rowFactory = O.createInstance(
                            n.DomRendererRowFactory,
                            document,
                          )),
                          this._element.classList.add(o + this._terminalClass),
                          this._screenElement.appendChild(this._rowContainer),
                          this._screenElement.appendChild(
                            this._selectionContainer,
                          ),
                          this.register(
                            this._linkifier2.onShowLinkUnderline((P) =>
                              this._handleLinkHover(P),
                            ),
                          ),
                          this.register(
                            this._linkifier2.onHideLinkUnderline((P) =>
                              this._handleLinkLeave(P),
                            ),
                          ),
                          this.register(
                            (0, t.toDisposable)(() => {
                          ...
                          (this._widthCache = new d.WidthCache(document)),
                      ...
                      _updateDimensions() {
                        ...
                        ((this.dimensions.device.char.width =
                          this._charSizeService.width * y),
                          (this.dimensions.device.char.height = Math.ceil(
                            this._charSizeService.height * y,
                          )),
                          ...
                          (this.dimensions.css.canvas.width = Math.round(
                            this.dimensions.device.canvas.width / y,
                          )),
                          (this.dimensions.css.canvas.height = Math.round(
                            this.dimensions.device.canvas.height / y,
                          )),
                          ...
                          (this.dimensions.css.cell.height =
                            ...
                            this._bufferService.rows));
                        for (const x of this._rowElements)
                          ((x.style.width = `${this.dimensions.css.canvas.width}px`),
                            (x.style.height = `${this.dimensions.css.cell.height}px`),
                            (x.style.lineHeight = `${this.dimensions.css.cell.height}px`),
                        ...
                        ((this._dimensionsStyleElement.textContent = k),
                      ...
                      _injectCss(y) {
                        ...
                        ((k += `${this._terminalSelector} .${l} .xterm-dim { color: ${e.color.multiplyOpacity(y.foreground, 0.5).css};}`),
                          (k += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`),
                          (k +=
                          ...
                          (k +=
                            ...
                            this._terminalClass +
                            ` { 0% {  background-color: ${y.cursor.css};  color: ${y.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${y.cursor.css}; }}`),
                          (k +=
                            `${this._terminalSelector} .${l}.${h} .xterm-cursor.xterm-cursor-blink:not(.xterm-cursor-block) { animation: blink_box_shadow_` +
                            this._terminalClass +
                            ` 1s step-end infinite;}${this._terminalSelector} .${l}.${h} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: blink_block_` +
                            this._terminalClass +
                            ` 1s step-end infinite;}${this._terminalSelector} .${l} .xterm-cursor.xterm-cursor-block { background-color: ${y.cursor.css}; color: ${y.cursorAccent.css};}${this._terminalSelector} .${l} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${y.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${l} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${y.cursor.css} inset;}${this._terminalSelector} .${l} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${y.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`),
                          (k += `${this._terminalSelector} .${g} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${g} div { position: absolute; background-color: ${y.selectionBackgroundOpaque.css};}${this._terminalSelector} .${g} div { position: absolute; background-color: ${y.selectionInactiveBackgroundOpaque.css};}`));
                        for (const [x, T] of y.ansi.entries())
                          k += `${this._terminalSelector} .${v}${x} { color: ${T.css}; }${this._terminalSelector} .${v}${x}.xterm-dim { color: ${e.color.multiplyOpacity(T, 0.5).css}; }${this._terminalSelector} .${m}${x} { background-color: ${T.css}; }`;
                        ((k += `${this._terminalSelector} .${v}${f.INVERTED_DEFAULT_COLOR} { color: ${e.color.opaque(y.background).css}; }${this._terminalSelector} .${v}${f.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${e.color.multiplyOpacity(e.color.opaque(y.background), 0.5).css}; }${this._terminalSelector} .${m}${f.INVERTED_DEFAULT_COLOR} { background-color: ${y.foreground.css}; }`),
                          (this._themeStyleElement.textContent = k));
                      }
                      _setDefaultSpacing() {
                        const y =
                          this.dimensions.css.cell.width -
                          this._widthCache.get('W', !1, !1);
                        ((this._rowContainer.style.letterSpacing = `${y}px`),
                          (this._rowFactory.defaultSpacing = y));
                      }
                      ...
                      _refreshRowElements(y, k) {
                        for (let x = this._rowElements.length; x <= k; x++) {
                          const T = document.createElement('div');
                          (this._rowContainer.appendChild(T),
                            this._rowElements.push(T));
                        }
                      ...
                      handleFocus() {
                        (this._rowContainer.classList.add(h),
                          this.renderRows(
                            this._bufferService.buffer.y,
                            this._bufferService.buffer.y,
                          ));
                      }
                      handleSelectionChanged(y, k, x) {
                        if (
                          (this._selectionContainer.replaceChildren(),
                          this._rowFactory.handleSelectionChanged(y, k, x),
                          this.renderRows(0, this._bufferService.rows - 1),
                          !y || !k)
                        )
                          return;
                        const T = y[1] - this._bufferService.buffer.ydisp,
                          O = k[1] - this._bufferService.buffer.ydisp,
                          M = Math.max(T, 0),
                          C = Math.min(O, this._bufferService.rows - 1);
                        if (M >= this._bufferService.rows || C < 0) return;
                        ...
                        if (x) {
                          ...
                          const E = T === M ? y[0] : 0,
                            D = M === O ? k[0] : this._bufferService.cols;
                          ...
                          if (
                            ...
                            const H = O === C ? k[0] : this._bufferService.cols;
                            w.appendChild(
                              this._createSelectionElement(C, 0, H),
                            );
                          }
                        }
                        this._selectionContainer.appendChild(w);
                      }
                      _createSelectionElement(y, k, x, T = 1) {
                        const O = document.createElement('div');
                        return (
                          (O.style.height =
                            T * this.dimensions.css.cell.height + 'px'),
                          (O.style.top =
                            y * this.dimensions.css.cell.height + 'px'),
                          (O.style.left =
                            k * this.dimensions.css.cell.width + 'px'),
                          (O.style.width =
                            this.dimensions.css.cell.width * (x - k) + 'px'),
                          O
                        );
                      }
                      handleCursorMove() {}
                      ...
                      renderRows(y, k) {
                        const x = this._bufferService.buffer,
                          T = x.ybase + x.y,
                          O = Math.min(x.x, this._bufferService.cols - 1),
                      ...
                      _setCellUnderline(y, k, x, T, O, M) {
                        (x < 0 && (y = 0), T < 0 && (k = 0));
                        const C = this._bufferService.rows - 1;
                        ((x = Math.max(Math.min(x, C), 0)),
                          (T = Math.max(Math.min(T, C), 0)),
                          (O = Math.min(O, this._bufferService.cols)));
                  ...
                  r.DomRenderer = L = c(
                    [
                      _(4, i.IInstantiationService),
                      _(5, u.ICharSizeService),
                      _(6, i.IOptionsService),
                      _(7, i.IBufferService),
                      _(8, u.ICoreBrowserService),
                      _(9, u.IThemeService),
                    ],
                    L,
                  );
                ...
                3787: function (I, r, a) {
                        ...
                        var b,
                          ...
                          y =
                            L < 3
                              ? m
                              : g === null
                                ? (g = Object.getOwnPropertyDescriptor(m, h))
                                : g;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          y = Reflect.decorate(v, m, h, g);
                        else
                          for (var k = v.length - 1; k >= 0; k--)
                            (b = v[k]) &&
                              (y =
                                (L < 3 ? b(y) : L > 3 ? b(m, h, y) : b(m, h)) ||
                                y);
                        return (
                          L > 3 && y && Object.defineProperty(m, h, y),
                          y
                        );
                      },
                    _ =
                  ...
                  let o = (r.DomRendererRowFactory = class {
                    ...
                    handleSelectionChanged(v, m, h) {
                      ((this._selectionStart = v),
                        ...
                        (this._columnSelectMode = h));
                    }
                    createRow(v, m, h, g, b, L, y, k, x, T, O) {
                      const M = [],
                        C = this._characterJoinerService.getJoinedCharacters(m),
                        w = this._themeService.colors;
                      let E,
                        D = v.getNoBgTrimmedLength();
                      h && D < L + 1 && (D = L + 1);
                      let P = 0,
                        H = '',
                        U = 0,
                      ...
                      const N = [],
                        F = T !== -1 && O !== -1;
                      for (let j = 0; j < D; j++) {
                        v.loadCell(j, this._workCell);
                        let V = this._workCell.getWidth();
                        if (V === 0) continue;
                        let G = !1,
                          ie = j,
                          $ = this._workCell;
                        if (C.length > 0 && j === C[0][0]) {
                          G = !0;
                          const K = C.shift();
                          (($ = new s.JoinedCellData(
                            this._workCell,
                            v.translateToString(!0, K[0], K[1]),
                            K[1] - K[0],
                          )),
                            (ie = K[1] - 1),
                            (V = $.getWidth()));
                        }
                        const se = this._isCellInSelection(j, m),
                          le = h && j === L,
                          ce = F && j >= T && j <= O;
                        let de = !1;
                        ...
                        let ae = $.getChars() || d.WHITESPACE_CELL_CHAR;
                        if (
                          (ae === ' ' &&
                            ($.isUnderline() || $.isOverline()) &&
                            (ae = ' '),
                          (A = V * k - x.get(ae, $.isBold(), $.isItalic())),
                          E)
                        ) {
                          if (
                            P &&
                            ((se && B) || (!se && !B && $.bg === U)) &&
                            ((se && B && w.selectionForeground) ||
                              $.fg === W) &&
                            $.extended.ext === z &&
                            ce === S &&
                            A === R &&
                        ...
                        if (
                          ...
                          (B = se),
                          G && L >= j && L <= ie && (L = j),
                          !this._coreService.isCursorHidden && le)
                        ) {
                          if (
                            (N.push('xterm-cursor'),
                            this._coreBrowserService.isFocused)
                          )
                            (y && N.push('xterm-cursor-blink'),
                              N.push(
                                g === 'bar'
                                  ? 'xterm-cursor-bar'
                                  : g === 'underline'
                        ...
                        if (
                          ($.isBold() && N.push('xterm-bold'),
                          $.isItalic() && N.push('xterm-italic'),
                          $.isDim() && N.push('xterm-dim'),
                          (H = $.isInvisible()
                            ? d.WHITESPACE_CELL_CHAR
                            : $.getChars() || d.WHITESPACE_CELL_CHAR),
                          $.isUnderline() &&
                            (N.push(
                              `xterm-underline-${$.extended.underlineStyle}`,
                            ),
                            H === ' ' && (H = ' '),
                            !$.isUnderlineColorDefault()))
                        )
                          if ($.isUnderlineColorRGB())
                            E.style.textDecorationColor = `rgb(${i.AttributeData.toColorRGB($.getUnderlineColor()).join(',')})`;
                          else {
                            let K = $.getUnderlineColor();
                            (this._optionsService.rawOptions
                              .drawBoldTextInBrightColors &&
                              $.isBold() &&
                              K < 8 &&
                              (K += 8),
                              (E.style.textDecorationColor = w.ansi[K].css));
                          }
                        ($.isOverline() &&
                          (N.push('xterm-overline'), H === ' ' && (H = ' ')),
                          $.isStrikethrough() && N.push('xterm-strikethrough'),
                          ce && (E.style.textDecoration = 'underline'));
                        let X = $.getFgColor(),
                          re = $.getFgColorMode(),
                          Y = $.getBgColor(),
                          ne = $.getBgColorMode();
                        ...
                        switch (
                            ...
                            (K) => {
                              (K.options.layer !== 'top' && oe) ||
                                (K.backgroundColorRGB &&
                                  ((ne = 50331648),
                                  (Y =
                                    (K.backgroundColorRGB.rgba >> 8) &
                                    16777215),
                                  (Q = K.backgroundColorRGB)),
                                K.foregroundColorRGB &&
                                  ((re = 50331648),
                                  (X =
                                    (K.foregroundColorRGB.rgba >> 8) &
                                    16777215),
                                  (_e = K.foregroundColorRGB)),
                          ...
                          !oe &&
                            ...
                            ((Q = this._coreBrowserService.isFocused
                              ? w.selectionBackgroundOpaque
                              : w.selectionInactiveBackgroundOpaque),
                            (Y = (Q.rgba >> 8) & 16777215),
                            (ne = 50331648),
                            (oe = !0),
                            w.selectionForeground &&
                              ((re = 50331648),
                              (X =
                                (w.selectionForeground.rgba >> 8) & 16777215),
                              (_e = w.selectionForeground))),
                          oe && N.push('xterm-decoration-top'),
                          ne)
                        ) {
                          case 16777216:
                          case 33554432:
                            ((ee = w.ansi[Y]), N.push(`xterm-bg-${Y}`));
                            break;
                          case 50331648:
                            ((ee = u.rgba.toColor(
                              Y >> 16,
                              ...
                              this._addStyle(
                                E,
                                `background-color:#${l((Y >>> 0).toString(16), '0', 6)}`,
                              ));
                            break;
                          default:
                            ue
                              ? ((ee = w.foreground),
                                N.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`))
                              : (ee = w.background);
                        }
                        switch (
                          (Q ||
                            ($.isDim() &&
                              (Q = u.color.multiplyOpacity(ee, 0.5))),
                          re)
                        ) {
                          case 16777216:
                          case 33554432:
                            ...
                            break;
                          case 50331648:
                            const K = u.rgba.toColor(
                              (X >> 16) & 255,
                              (X >> 8) & 255,
                              255 & X,
                            );
                            this._applyMinimumContrast(E, ee, K, $, Q, _e) ||
                              this._addStyle(
                                E,
                                `color:#${l(X.toString(16), '0', 6)}`,
                              );
                            break;
                          default:
                            this._applyMinimumContrast(
                              ...
                              (ue &&
                                N.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`));
                        }
                        (N.length &&
                          ((E.className = N.join(' ')), (N.length = 0)),
                          le || G || de ? (E.textContent = H) : P++,
                          A !== this.defaultSpacing &&
                            (E.style.letterSpacing = `${A}px`),
                          M.push(E),
                          (j = ie));
                      }
                      return (E && P && (E.textContent = H), M);
                    }
                    _applyMinimumContrast(v, m, h, g, b, L) {
                      if (
                        this._optionsService.rawOptions.minimumContrastRatio ===
                          1 ||
                        (0, t.excludeFromContrastRatioDemands)(g.getCode())
                      )
                        return !1;
                      const y = this._getContrastCache(g);
                      let k;
                      if (
                        (b || L || (k = y.getColor(m.rgba, h.rgba)),
                        k === void 0)
                      ) {
                        const x =
                          this._optionsService.rawOptions.minimumContrastRatio /
                          (g.isDim() ? 2 : 1);
                        ((k = u.color.ensureContrastRatio(b || m, L || h, x)),
                          y.setColor((b || m).rgba, (L || h).rgba, k ?? null));
                      }
                    ...
                    _addStyle(v, m) {
                      v.setAttribute(
                        'style',
                        `${v.getAttribute('style') || ''}${m};`,
                      );
                    }
                    _isCellInSelection(v, m) {
                      const h = this._selectionStart,
                        g = this._selectionEnd;
                      return (
                        !(!h || !g) &&
                        (this._columnSelectMode
                          ? h[0] <= g[0]
                            ? v >= h[0] && m >= h[1] && v < g[0] && m <= g[1]
                            : v < h[0] && m >= h[1] && v >= g[0] && m <= g[1]
                          : (m > h[1] && m < g[1]) ||
                            (h[1] === g[1] &&
                              m === h[1] &&
                  ...
                  r.DomRendererRowFactory = o = c(
                    [
                      _(1, e.ICharacterJoinerService),
                      _(2, p.IOptionsService),
                      _(3, e.ICoreBrowserService),
                      _(4, p.ICoreService),
                      _(5, p.IDecorationService),
                      _(6, e.IThemeService),
                    ],
                    o,
                  );
                    ...
                    (r.WidthCache = class {
                      ...
                      get(a, c, _) {
                        ...
                        if (
                          ...
                          return this._flat[n] !== -9999
                            ? this._flat[n]
                            : (this._flat[n] = this._measure(a, 0));
                        let d = a;
                        (c && (d += 'B'), _ && (d += 'I'));
                ...
                6171: (I, r) => {
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.createRenderDimensions =
                      r.excludeFromContrastRatioDemands =
                      r.isRestrictedPowerlineGlyph =
                      r.isPowerlineGlyph =
                      r.throwIfFalsy =
                        void 0),
                    (r.throwIfFalsy = function (c) {
                      if (!c) throw new Error('value must not be falsy');
                      return c;
                    }),
                    (r.isPowerlineGlyph = a),
                    (r.isRestrictedPowerlineGlyph = function (c) {
                ...
                428: function (I, r, a) {
                  ...
                  const n = a(2585),
                    d = a(8460),
                    f = a(844);
                  let p = (r.CharSizeService = class extends f.Disposable {
                    get hasValidSize() {
                  ...
                  r.CharSizeService = p = c([_(2, n.IOptionsService)], p);
                  class u {
                    constructor(s, t, i) {
                      ((this._document = s),
                    ...
                    measure() {
                      ...
                      return (
                        s.width !== 0 &&
                          s.height !== 0 &&
                          ((this._result.width = s.width / 32),
                          (this._result.height = Math.ceil(s.height))),
                        this._result
                      );
                    }
                  }
                ...
                4269: function (I, r, a) {
                  ...
                  r.JoinedCellData = u;
                  let e = (r.CharacterJoinerService = class me {
                    constructor(t) {
                    ...
                    deregister(t) {
                      for (let i = 0; i < this._characterJoiners.length; i++)
                        if (this._characterJoiners[i].id === t)
                    ...
                    getJoinedCharacters(t) {
                      ...
                      const o = [],
                        l = i.translateToString(!0);
                      let v = 0,
                        m = 0,
                        h = 0,
                        g = i.getFg(0),
                        b = i.getBg(0);
                      for (let L = 0; L < i.getTrimmedLength(); L++)
                        if (
                          (i.loadCell(L, this._workCell),
                      ...
                      if (this._bufferService.cols - v > 1) {
                        const L = this._getJoinedRanges(l, h, m, i, v);
                    ...
                    _getJoinedRanges(t, i, o, l, v) {
                      ...
                      for (let g = 1; g < this._characterJoiners.length; g++)
                        try {
                          const b = this._characterJoiners[g].handler(m);
                          for (let L = 0; L < b.length; L++)
                            me._mergeRanges(h, b[L]);
                        } catch (b) {
                          console.error(b);
                        }
                    ...
                    _stringRangesToCellRanges(t, i, o) {
                      let l = 0,
                        ...
                        h = t[l];
                      if (h) {
                        for (let g = o; g < this._bufferService.cols; g++) {
                          const b = i.getWidth(g),
                            L =
                              i.getString(g).length ||
                              d.WHITESPACE_CELL_CHAR.length;
                          if (b !== 0) {
                            if (
                              (!v && h[0] <= m && ((h[0] = g), (v = !0)),
                    ...
                    static _mergeRanges(t, i) {
                      ...
                      for (let l = 0; l < t.length; l++) {
                        ...
                        if (o) {
                          ...
                          if (i[1] <= v[1])
                            return ((v[0] = Math.min(i[0], v[0])), t);
                          i[0] < v[1] &&
                            ((v[0] = Math.min(i[0], v[0])), (o = !0));
                        }
                      }
                      return (o ? (t[t.length - 1][1] = i[1]) : t.push(i), t);
                    }
                  });
                  r.CharacterJoinerService = e = c([_(0, p.IBufferService)], e);
                },
                5114: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.CoreBrowserService = void 0),
                    (r.CoreBrowserService = class {
                      constructor(a, c) {
                        ((this._textarea = a),
                          (this.window = c),
                          (this._isFocused = !1),
                ...
                8934: function (I, r, a) {
                        ...
                        var t,
                          ...
                          o =
                            i < 3
                              ? u
                              : s === null
                                ? (s = Object.getOwnPropertyDescriptor(u, e))
                                : s;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          o = Reflect.decorate(p, u, e, s);
                        else
                          for (var l = p.length - 1; l >= 0; l--)
                            (t = p[l]) &&
                              (o =
                                (i < 3 ? t(o) : i > 3 ? t(u, e, o) : t(u, e)) ||
                                o);
                        return (
                          i > 3 && o && Object.defineProperty(u, e, o),
                          o
                        );
                      },
                    _ =
                  ...
                  let f = (r.MouseService = class {
                    constructor(p, u) {
                      ((this._renderService = p), (this._charSizeService = u));
                    }
                    getCoords(p, u, e, s, t) {
                    ...
                    getMouseReportCoords(p, u) {
                      const e = (0, d.getCoordsRelativeToElement)(window, p, u);
                ...
                3230: function (I, r, a) {
                  ...
                  let i = (r.RenderService = class extends e.Disposable {
                    ...
                    constructor(o, l, v, m, h, g, b, L) {
                      if (
                        ...
                        (this._pausedResizeTask = new s.DebouncedIdleTask()),
                        (this._isPaused = !1),
                        ...
                        (this._onRender = this.register(new u.EventEmitter())),
                        (this.onRender = this._onRender.event),
                        (this._onRefreshRequest = this.register(
                          new u.EventEmitter(),
                        )),
                        (this.onRefreshRequest = this._onRefreshRequest.event),
                        (this._renderDebouncer = new d.RenderDebouncer(
                          b.window,
                          (y, k) => this._renderRows(y, k),
                        )),
                        this.register(this._renderDebouncer),
                        (this._screenDprMonitor = new f.ScreenDprMonitor(
                          b.window,
                        )),
                        this._screenDprMonitor.setListener(() =>
                        ...
                        this.register(this._screenDprMonitor),
                        this.register(g.onResize(() => this._fullRefresh())),
                        this.register(
                          g.buffers.onBufferActivate(() => {
                            var y;
                            return (y = this._renderer.value) === null ||
                              y === void 0
                              ? void 0
                              : y.clear();
                          }),
                        ...
                        this.register(
                          v.onOptionChange(() => this._handleOptionsChanged()),
                        ),
                        this.register(
                        ...
                        this.register(
                          h.onDecorationRegistered(() => this._fullRefresh()),
                        ),
                        this.register(
                          h.onDecorationRemoved(() => this._fullRefresh()),
                        ),
                        this.register(
                          v.onMultipleOptionChange(
                            [
                              'customGlyphs',
                              'drawBoldTextInBrightColors',
                              'letterSpacing',
                            ...
                            () => {
                              (this.clear(),
                                this.handleResize(g.cols, g.rows),
                                this._fullRefresh());
                            },
                          ),
                        ),
                        this.register(
                          v.onMultipleOptionChange(
                            ...
                            () => this.refreshRows(g.buffer.y, g.buffer.y, !0),
                          ),
                        ),
                        this.register(
                          (0, n.addDisposableDomListener)(
                        ...
                        this.register(
                          L.onChangeColors(() => this._fullRefresh()),
                        ),
                        'IntersectionObserver' in b.window)
                      ) {
                        const y = new b.window.IntersectionObserver(
                          (k) =>
                            this._handleIntersectionChange(k[k.length - 1]),
                          { threshold: 0 },
                        );
                        (y.observe(l),
                          this.register({ dispose: () => y.disconnect() }));
                      }
                    }
                    ...
                    refreshRows(o, l, v = !1) {
                      this._isPaused
                        ...
                        : (v || (this._isNextRenderRedrawOnly = !1),
                          this._renderDebouncer.refresh(o, l, this._rowCount));
                    }
                    _renderRows(o, l) {
                      this._renderer.value &&
                        ((o = Math.min(o, this._rowCount - 1)),
                        (l = Math.min(l, this._rowCount - 1)),
                        this._renderer.value.renderRows(o, l),
                        ...
                        this._onRender.fire({ start: o, end: l }),
                        (this._isNextRenderRedrawOnly = !0));
                    }
                    resize(o, l) {
                    ...
                    setRenderer(o) {
                      ((this._renderer.value = o),
                        this._renderer.value.onRequestRedraw((l) =>
                          this.refreshRows(l.start, l.end, !0),
                        ),
                    ...
                    clearTextureAtlas() {
                      var o, l;
                      this._renderer.value &&
                        ((l = (o = this._renderer.value).clearTextureAtlas) ===
                          null ||
                          l === void 0 ||
                          l.call(o),
                        this._fullRefresh());
                      ...
                      this._renderer.value &&
                        (this._isPaused
                          ? this._pausedResizeTask.set(() =>
                              this._renderer.value.handleResize(o, l),
                            )
                          : this._renderer.value.handleResize(o, l),
                        this._fullRefresh());
                    }
                    handleCharSizeChanged() {
                      var o;
                      (o = this._renderer.value) === null ||
                        o === void 0 ||
                        o.handleCharSizeChanged();
                    }
                    handleBlur() {
                      var o;
                      (o = this._renderer.value) === null ||
                    ...
                    handleSelectionChanged(o, l, v) {
                      var m;
                      ((this._selectionState.start = o),
                        (this._selectionState.end = l),
                        (this._selectionState.columnSelectMode = v),
                        (m = this._renderer.value) === null ||
                          m === void 0 ||
                          m.handleSelectionChanged(o, l, v));
                    }
                    handleCursorMove() {
                      var o;
                      (o = this._renderer.value) === null ||
                  ...
                  r.RenderService = i = c(
                    [
                      _(2, t.IOptionsService),
                      _(3, p.ICharSizeService),
                      _(4, t.IDecorationService),
                      _(5, t.IBufferService),
                      _(6, p.ICoreBrowserService),
                      _(7, p.IThemeService),
                    ],
                    i,
                  );
                        ...
                        var y,
                          ...
                          x =
                            k < 3
                              ? g
                              : L === null
                                ? (L = Object.getOwnPropertyDescriptor(g, b))
                                : L;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          x = Reflect.decorate(h, g, b, L);
                        else
                          for (var T = h.length - 1; T >= 0; T--)
                            (y = h[T]) &&
                              (x =
                                (k < 3 ? y(x) : k > 3 ? y(g, b, x) : y(g, b)) ||
                                x);
                        return (
                          k > 3 && x && Object.defineProperty(g, b, x),
                          x
                        );
                      },
                    _ =
                  ...
                  let m = (r.SelectionService = class extends e.Disposable {
                    constructor(h, g, b, L, y, k, x, T, O) {
                      (super(),
                        ...
                        (this.onRequestScrollLines =
                          this._onRequestScrollLines.event),
                        (this._mouseMoveListener = (M) =>
                          this._handleMouseMove(M)),
                        (this._mouseUpListener = (M) => this._handleMouseUp(M)),
                        this._coreService.onUserInput(() => {
                          this.hasSelection && this.clearSelection();
                        }),
                        (this._trimListener =
                          this._bufferService.buffer.lines.onTrim((M) =>
                            this._handleTrim(M),
                          )),
                        this.register(
                          this._bufferService.buffers.onBufferActivate((M) =>
                            this._handleBufferActivate(M),
                          ),
                        ),
                        this.enable(),
                        (this._model = new f.SelectionModel(
                          this._bufferService,
                        )),
                    ...
                    get hasSelection() {
                      const h = this._model.finalSelectionStart,
                        g = this._model.finalSelectionEnd;
                      return !(!h || !g || (h[0] === g[0] && h[1] === g[1]));
                    }
                    get selectionText() {
                      const h = this._model.finalSelectionStart,
                        g = this._model.finalSelectionEnd;
                      ...
                      if (this._activeSelectionMode === 3) {
                        if (h[0] === g[0]) return '';
                        const y = h[0] < g[0] ? h[0] : g[0],
                          k = h[0] < g[0] ? g[0] : h[0];
                        for (let x = h[1]; x <= g[1]; x++) {
                          const T = b.translateBufferLineToString(x, !0, y, k);
                          L.push(T);
                        }
                      } else {
                        const y = h[1] === g[1] ? g[0] : void 0;
                        L.push(
                          b.translateBufferLineToString(h[1], !0, h[0], y),
                        );
                        for (let k = h[1] + 1; k <= g[1] - 1; k++) {
                          const x = b.lines.get(k),
                            T = b.translateBufferLineToString(k, !0);
                          x?.isWrapped ? (L[L.length - 1] += T) : L.push(T);
                        }
                        if (h[1] !== g[1]) {
                          const k = b.lines.get(g[1]),
                            x = b.translateBufferLineToString(
                              g[1],
                              !0,
                              0,
                              g[0],
                            );
                          k && k.isWrapped ? (L[L.length - 1] += x) : L.push(x);
                        }
                      }
                      return L.map((y) => y.replace(v, ' ')).join(
                        s.isWindows
                          ? `\r
`
                          : `
`,
                    ...
                    _isClickInSelection(h) {
                      const g = this._getMouseBufferCoords(h),
                        b = this._model.finalSelectionStart,
                        L = this._model.finalSelectionEnd;
                      return (
                        !!(b && L && g) && this._areCoordsInSelection(g, b, L)
                      );
                    }
                    isCellInSelection(h, g) {
                      const b = this._model.finalSelectionStart,
                        L = this._model.finalSelectionEnd;
                      return (
                        !(!b || !L) && this._areCoordsInSelection([h, g], b, L)
                      );
                    }
                    _areCoordsInSelection(h, g, b) {
                      return (
                        (h[1] > g[1] && h[1] < b[1]) ||
                        (g[1] === b[1] &&
                          h[1] === g[1] &&
                          h[0] >= g[0] &&
                          h[0] < b[0]) ||
                        (g[1] < b[1] && h[1] === b[1] && h[0] < b[0]) ||
                        (g[1] < b[1] && h[1] === g[1] && h[0] >= g[0])
                      );
                    }
                    _selectWordAtCursor(h, g) {
                      var b, L;
                      const y =
                        (L =
                          (b = this._linkifier.currentLink) === null ||
                          b === void 0
                            ? void 0
                            : b.link) === null || L === void 0
                          ? void 0
                          : L.range;
                      if (y)
                        return (
                          ...
                          t.getRangeLength)(y, this._bufferService.cols)),
                    ...
                    selectLines(h, g) {
                      (this._model.clearSelection(),
                        ...
                        (this._model.selectionStart = [0, h]),
                    ...
                    _getMouseBufferCoords(h) {
                      const g = this._mouseService.getCoords(
                        h,
                        this._screenElement,
                        this._bufferService.cols,
                        this._bufferService.rows,
                    ...
                    _getMouseEventScrollAmount(h) {
                      let g = (0, n.getCoordsRelativeToElement)(
                      ...
                      return g >= 0 && g <= b
                        ? 0
                        : (g > b && (g -= b),
                          (g = Math.min(Math.max(g, -50), 50)),
                          (g /= 50),
                          g / Math.abs(g) + Math.round(14 * g));
                    }
                    ...
                    handleMouseDown(h) {
                      if (
                        ((this._mouseDownTimeStamp = h.timeStamp),
                        (h.button !== 2 || !this.hasSelection) &&
                          h.button === 0)
                      ) {
                        if (!this._enabled) {
                        ...
                        (h.preventDefault(),
                          (this._dragScrollAmount = 0),
                          this._enabled && h.shiftKey
                            ? this._handleIncrementalClick(h)
                            : h.detail === 1
                              ? this._handleSingleClick(h)
                              : h.detail === 2
                                ? this._handleDoubleClick(h)
                                : h.detail === 3 && this._handleTripleClick(h),
                    ...
                    _handleIncrementalClick(h) {
                      this._model.selectionStart &&
                        (this._model.selectionEnd =
                          this._getMouseBufferCoords(h));
                    }
                    _handleSingleClick(h) {
                      if (
                        ((this._model.selectionStartLength = 0),
                        (this._model.isSelectAllActive = !1),
                        (this._activeSelectionMode = this.shouldColumnSelect(h)
                          ? 3
                          : 0),
                        (this._model.selectionStart =
                          this._getMouseBufferCoords(h)),
                        ...
                        return;
                      this._model.selectionEnd = void 0;
                      const g = this._bufferService.buffer.lines.get(
                        this._model.selectionStart[1],
                      );
                      g &&
                        g.length !== this._model.selectionStart[0] &&
                        g.hasWidth(this._model.selectionStart[0]) === 0 &&
                        this._model.selectionStart[0]++;
                    }
                    _handleDoubleClick(h) {
                      this._selectWordAtCursor(h, !0) &&
                    ...
                    _handleMouseMove(h) {
                      if (
                        ...
                        return;
                      const g = this._model.selectionEnd
                        ? [
                      ...
                      (this._activeSelectionMode === 2
                        ...
                        (this._dragScrollAmount =
                          this._getMouseEventScrollAmount(h)),
                      ...
                      if (this._model.selectionEnd[1] < b.lines.length) {
                        const L = b.lines.get(this._model.selectionEnd[1]);
                        L &&
                          L.hasWidth(this._model.selectionEnd[0]) === 0 &&
                          this._model.selectionEnd[0]++;
                      }
                      (g &&
                        g[0] === this._model.selectionEnd[0] &&
                        g[1] === this._model.selectionEnd[1]) ||
                        this.refresh(!0);
                    }
                    _dragScroll() {
                      if (
                        ...
                        (this._dragScrollAmount > 0
                          ? (this._activeSelectionMode !== 3 &&
                            ...
                            (this._model.selectionEnd[1] = Math.min(
                              h.ydisp + this._bufferService.rows,
                              h.lines.length - 1,
                            )))
                          : (this._activeSelectionMode !== 3 &&
                              (this._model.selectionEnd[0] = 0),
                            (this._model.selectionEnd[1] = h.ydisp)),
                          this.refresh());
                      }
                    }
                    _handleMouseUp(h) {
                      const g = h.timeStamp - this._mouseDownTimeStamp;
                      if (
                        (this._removeMouseDownListeners(),
                        ...
                        if (
                          ...
                          const b = this._mouseService.getCoords(
                            h,
                            this._element,
                            this._bufferService.cols,
                            this._bufferService.rows,
                          ...
                          if (b && b[0] !== void 0 && b[1] !== void 0) {
                            const L = (0, d.moveToCellSequence)(
                              b[0] - 1,
                              b[1] - 1,
                              this._bufferService,
                    ...
                    _fireEventIfSelectionChanged() {
                      const h = this._model.finalSelectionStart,
                        g = this._model.finalSelectionEnd,
                        b = !(!h || !g || (h[0] === g[0] && h[1] === g[1]));
                      b
                        ? h &&
                          g &&
                          ((this._oldSelectionStart &&
                            this._oldSelectionEnd &&
                            h[0] === this._oldSelectionStart[0] &&
                            h[1] === this._oldSelectionStart[1] &&
                            g[0] === this._oldSelectionEnd[0] &&
                            g[1] === this._oldSelectionEnd[1]) ||
                            this._fireOnSelectionChange(h, g, b))
                        : this._oldHasSelection &&
                          this._fireOnSelectionChange(h, g, b);
                    }
                    _fireOnSelectionChange(h, g, b) {
                      ((this._oldSelectionStart = h),
                        (this._oldSelectionEnd = g),
                        (this._oldHasSelection = b),
                        this._onSelectionChange.fire());
                    }
                    _handleBufferActivate(h) {
                      (this.clearSelection(),
                        this._trimListener.dispose(),
                        (this._trimListener = h.activeBuffer.lines.onTrim((g) =>
                          this._handleTrim(g),
                        )));
                    }
                    _convertViewportColToCharacterIndex(h, g) {
                      let b = g;
                      for (let L = 0; g >= L; L++) {
                        const y = h
                          .loadCell(L, this._workCell)
                          .getChars().length;
                        this._workCell.getWidth() === 0
                          ? b--
                          : y > 1 && g !== L && (b += y - 1);
                    ...
                    setSelection(h, g, b) {
                      (this._model.clearSelection(),
                        this._removeMouseDownListeners(),
                        (this._model.selectionStart = [h, g]),
                        (this._model.selectionStartLength = b),
                        this.refresh(),
                        this._fireEventIfSelectionChanged());
                    }
                    rightClickSelect(h) {
                      this._isClickInSelection(h) ||
                        (this._selectWordAtCursor(h, !1) && this.refresh(!0),
                        this._fireEventIfSelectionChanged());
                    }
                    _getWordAt(h, g, b = !0, L = !0) {
                      if (h[0] >= this._bufferService.cols) return;
                      const y = this._bufferService.buffer,
                        k = y.lines.get(h[1]);
                      if (!k) return;
                      const x = y.translateBufferLineToString(h[1], !1);
                      let T = this._convertViewportColToCharacterIndex(k, h[0]),
                        O = T;
                      const M = h[0] - T;
                      let C = 0,
                        w = 0,
                        ...
                        D = 0;
                      if (x.charAt(T) === ' ') {
                        for (; T > 0 && x.charAt(T - 1) === ' '; ) T--;
                        for (; O < x.length && x.charAt(O + 1) === ' '; ) O++;
                      } else {
                        let U = h[0],
                          W = h[0];
                        (k.getWidth(U) === 0 && (C++, U--),
                          k.getWidth(W) === 2 && (w++, W++));
                        const z = k.getString(W).length;
                        for (
                          z > 1 && ((D += z - 1), (O += z - 1));
                          U > 0 &&
                          T > 0 &&
                          !this._isCharWordSeparator(
                            k.loadCell(U - 1, this._workCell),
                          );
                        ) {
                          k.loadCell(U - 1, this._workCell);
                      ...
                      if (g || x.slice(T, O).trim() !== '') {
                        if (b && P === 0 && k.getCodePoint(0) !== 32) {
                          const U = y.lines.get(h[1] - 1);
                          if (
                            U &&
                            k.isWrapped &&
                            U.getCodePoint(this._bufferService.cols - 1) !== 32
                          ) {
                            const W = this._getWordAt(
                              [this._bufferService.cols - 1, h[1] - 1],
                              !1,
                              !0,
                              !1,
                            );
                            if (W) {
                              const z = this._bufferService.cols - W.start;
                              ((P -= z), (H += z));
                            }
                          }
                        }
                        if (
                          L &&
                          P + H === this._bufferService.cols &&
                          k.getCodePoint(this._bufferService.cols - 1) !== 32
                        ) {
                          const U = y.lines.get(h[1] + 1);
                          if (U?.isWrapped && U.getCodePoint(0) !== 32) {
                            const W = this._getWordAt(
                              [0, h[1] + 1],
                              !1,
                              !1,
                        ...
                        return { start: P, length: H };
                      }
                    }
                    _selectWordAt(h, g) {
                      const b = this._getWordAt(h, g);
                      if (b) {
                        for (; b.start < 0; )
                          ((b.start += this._bufferService.cols), h[1]--);
                        ((this._model.selectionStart = [b.start, h[1]]),
                          (this._model.selectionStartLength = b.length));
                      }
                    }
                    _selectToWordAt(h) {
                      const g = this._getWordAt(h, !0);
                      if (g) {
                        let b = h[1];
                        for (; g.start < 0; )
                          ((g.start += this._bufferService.cols), b--);
                        if (!this._model.areSelectionValuesReversed())
                          for (
                            ;
                            g.start + g.length > this._bufferService.cols;
                          )
                            ((g.length -= this._bufferService.cols), b++);
                        this._model.selectionEnd = [
                    ...
                    _selectLineAt(h) {
                      const g =
                          this._bufferService.buffer.getWrappedRangeForLine(h),
                        b = {
                          start: { x: 0, y: g.first },
                          end: { x: this._bufferService.cols - 1, y: g.last },
                        };
                      ((this._model.selectionStart = [0, g.first]),
                        (this._model.selectionEnd = void 0),
                        (this._model.selectionStartLength = (0,
                        t.getRangeLength)(b, this._bufferService.cols)));
                    }
                  });
                  r.SelectionService = m = c(
                    [
                      _(3, o.IBufferService),
                      _(4, o.ICoreService),
                      _(5, p.IMouseService),
                      _(6, o.IOptionsService),
                      _(7, p.IRenderService),
                      _(8, p.ICoreBrowserService),
                    ],
                    m,
                  );
                },
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.IThemeService =
                      ...
                      r.ICharSizeService =
                        void 0));
                  const c = a(8343);
                  ((r.ICharSizeService = (0, c.createDecorator)(
                    'CharSizeService',
                  )),
                    (r.ICoreBrowserService = (0, c.createDecorator)(
                      'CoreBrowserService',
                    )),
                    (r.IMouseService = (0, c.createDecorator)('MouseService')),
                    (r.IRenderService = (0, c.createDecorator)(
                      'RenderService',
                    )),
                    (r.ISelectionService = (0, c.createDecorator)(
                      'SelectionService',
                    )),
                    (r.ICharacterJoinerService = (0, c.createDecorator)(
                      'CharacterJoinerService',
                    )),
                    (r.IThemeService = (0, c.createDecorator)('ThemeService')));
                },
                6731: function (I, r, a) {
                  var c =
                      (this && this.__decorate) ||
                        ...
                        var L,
                          ...
                          k =
                            y < 3
                              ? h
                              : b === null
                                ? (b = Object.getOwnPropertyDescriptor(h, g))
                                : b;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          k = Reflect.decorate(m, h, g, b);
                        else
                          for (var x = m.length - 1; x >= 0; x--)
                            (L = m[x]) &&
                              (k =
                                (y < 3 ? L(k) : y > 3 ? L(h, g, k) : L(h, g)) ||
                                k);
                        return (
                          y > 3 && k && Object.defineProperty(h, g, k),
                          k
                        );
                      },
                    _ =
                  ...
                  r.DEFAULT_ANSI_COLORS = Object.freeze(
                    (() => {
                      const m = [
                        ...
                        h = [0, 95, 135, 175, 215, 255];
                      for (let g = 0; g < 216; g++) {
                        const b = h[((g / 36) % 6) | 0],
                          L = h[((g / 6) % 6) | 0],
                          y = h[g % 6];
                        m.push({
                          css: d.channels.toCss(b, L, y),
                          rgba: d.channels.toRgba(b, L, y),
                        });
                      }
                      for (let g = 0; g < 24; g++) {
                        const b = 8 + 10 * g;
                        m.push({
                          css: d.channels.toCss(b, b, b),
                          rgba: d.channels.toRgba(b, b, b),
                        });
                      }
                      return m;
                    })(),
                  );
                  let l = (r.ThemeService = class extends p.Disposable {
                    get colors() {
                      return this._colors;
                    }
                    constructor(m) {
                      (super(),
                        ...
                        (this._colors = {
                          ...
                          selectionInactiveBackgroundOpaque: d.color.blend(
                            s,
                            o,
                          ),
                    ...
                    _setTheme(m = {}) {
                      ...
                      if (
                        ((h.foreground = v(m.foreground, e)),
                        (h.background = v(m.background, s)),
                        (h.cursor = v(m.cursor, t)),
                        (h.cursorAccent = v(m.cursorAccent, i)),
                        (h.selectionBackgroundTransparent = v(
                          m.selectionBackground,
                          o,
                        )),
                        (h.selectionBackgroundOpaque = d.color.blend(
                          h.background,
                          h.selectionBackgroundTransparent,
                        )),
                        (h.selectionInactiveBackgroundTransparent = v(
                          m.selectionInactiveBackground,
                          h.selectionBackgroundTransparent,
                        )),
                        (h.selectionInactiveBackgroundOpaque = d.color.blend(
                          h.background,
                          h.selectionInactiveBackgroundTransparent,
                        )),
                        (h.selectionForeground = m.selectionForeground
                          ? v(m.selectionForeground, d.NULL_COLOR)
                          : void 0),
                        h.selectionForeground === d.NULL_COLOR &&
                          (h.selectionForeground = void 0),
                        d.color.isOpaque(h.selectionBackgroundTransparent) &&
                          (h.selectionBackgroundTransparent = d.color.opacity(
                            h.selectionBackgroundTransparent,
                            0.3,
                          )),
                        d.color.isOpaque(
                        ...
                        (h.ansi = r.DEFAULT_ANSI_COLORS.slice()),
                        (h.ansi[0] = v(m.black, r.DEFAULT_ANSI_COLORS[0])),
                        (h.ansi[1] = v(m.red, r.DEFAULT_ANSI_COLORS[1])),
                        (h.ansi[2] = v(m.green, r.DEFAULT_ANSI_COLORS[2])),
                        (h.ansi[3] = v(m.yellow, r.DEFAULT_ANSI_COLORS[3])),
                        (h.ansi[4] = v(m.blue, r.DEFAULT_ANSI_COLORS[4])),
                        (h.ansi[5] = v(m.magenta, r.DEFAULT_ANSI_COLORS[5])),
                        (h.ansi[6] = v(m.cyan, r.DEFAULT_ANSI_COLORS[6])),
                        (h.ansi[7] = v(m.white, r.DEFAULT_ANSI_COLORS[7])),
                        (h.ansi[8] = v(
                          m.brightBlack,
                          r.DEFAULT_ANSI_COLORS[8],
                        )),
                        (h.ansi[9] = v(m.brightRed, r.DEFAULT_ANSI_COLORS[9])),
                        (h.ansi[10] = v(
                          m.brightGreen,
                        ...
                        const g = Math.min(
                          h.ansi.length - 16,
                          m.extendedAnsi.length,
                        );
                        for (let b = 0; b < g; b++)
                          h.ansi[b + 16] = v(
                            m.extendedAnsi[b],
                            r.DEFAULT_ANSI_COLORS[b + 16],
                          );
                      }
                      (this._contrastCache.clear(),
                    ...
                    _restoreColor(m) {
                      if (m !== void 0)
                        ...
                        for (
                          let h = 0;
                          h < this._restoreColors.ansi.length;
                          ++h
                        )
                          this._colors.ansi[h] = this._restoreColors.ansi[h];
                    }
                    modifyColors(m) {
                  ...
                  r.ThemeService = l = c([_(0, u.IOptionsService)], l);
                },
                6349: (I, r, a) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                  ...
                  class n extends _.Disposable {
                    ...
                    set maxLength(f) {
                      ...
                      const p = new Array(f);
                      for (let u = 0; u < Math.min(f, this.length); u++)
                        p[u] = this._array[this._getCyclicIndex(u)];
                      ((this._array = p),
                        (this._maxLength = f),
                        (this._startIndex = 0));
                    }
                    ...
                    set(f, p) {
                      this._array[this._getCyclicIndex(f)] = p;
                    }
                    push(f) {
                    ...
                    splice(f, p, ...u) {
                      if (p) {
                        for (let e = f; e < this._length - p; e++)
                          this._array[this._getCyclicIndex(e)] =
                            this._array[this._getCyclicIndex(e + p)];
                        ((this._length -= p),
                          this.onDeleteEmitter.fire({ index: f, amount: p }));
                      }
                      for (let e = this._length - 1; e >= f; e--)
                        this._array[this._getCyclicIndex(e + u.length)] =
                          this._array[this._getCyclicIndex(e)];
                      for (let e = 0; e < u.length; e++)
                        this._array[this._getCyclicIndex(f + e)] = u[e];
                      if (
                        (u.length &&
                        ...
                        this._length + u.length > this._maxLength)
                      ) {
                    ...
                    shiftElements(f, p, u) {
                      if (!(p <= 0)) {
                        ...
                        if (u > 0) {
                          for (let s = p - 1; s >= 0; s--)
                            this.set(f + s + u, this.get(f + s));
                          const e = f + p + u - this._length;
                          if (e > 0)
                            for (
                              this._length += e;
                              this._length > this._maxLength;
                ...
                1439: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.clone = void 0),
                    (r.clone = function a(c, _ = 5) {
                      if (typeof c != 'object') return c;
                      const n = Array.isArray(c) ? [] : {};
                      for (const d in c)
                        n[d] = _ <= 1 ? c[d] : c[d] && a(c[d], _ - 1);
                      return n;
                    }));
                },
                8055: (I, r, a) => {
                  ...
                  ((r.NULL_COLOR = { css: '#00000000', rgba: 0 }),
                    (function (l) {
                      ((l.toCss = function (v, m, h, g) {
                        return g !== void 0
                          ? `#${i(v)}${i(m)}${i(h)}${i(g)}`
                          : `#${i(v)}${i(m)}${i(h)}`;
                      }),
                        (l.toRgba = function (v, m, h, g = 255) {
                          return ((v << 24) | (m << 16) | (h << 8) | g) >>> 0;
                        }));
                    })(p || (r.channels = p = {})),
                    (function (l) {
                      function v(m, h) {
                        return (
                          (f = Math.round(255 * h)),
                          ([_, n, d] = t.toChannels(m.rgba)),
                          {
                            css: p.toCss(_, n, d, f),
                            rgba: p.toRgba(_, n, d, f),
                          }
                        );
                      }
                      ((l.blend = function (m, h) {
                        if (((f = (255 & h.rgba) / 255), f === 1))
                          return { css: h.css, rgba: h.rgba };
                        const g = (h.rgba >> 24) & 255,
                          b = (h.rgba >> 16) & 255,
                          L = (h.rgba >> 8) & 255,
                          y = (m.rgba >> 24) & 255,
                          k = (m.rgba >> 16) & 255,
                          x = (m.rgba >> 8) & 255;
                        return (
                          (_ = y + Math.round((g - y) * f)),
                          (n = k + Math.round((b - k) * f)),
                          (d = x + Math.round((L - x) * f)),
                          { css: p.toCss(_, n, d), rgba: p.toRgba(_, n, d) }
                        );
                      }),
                        (l.isOpaque = function (m) {
                          return (255 & m.rgba) == 255;
                        }),
                        (l.ensureContrastRatio = function (m, h, g) {
                          const b = t.ensureContrastRatio(m.rgba, h.rgba, g);
                          if (b)
                            return t.toColor(
                              (b >> 24) & 255,
                              (b >> 16) & 255,
                        ...
                        (l.opaque = function (m) {
                          ...
                          return (
                            ([_, n, d] = t.toChannels(h)),
                            { css: p.toCss(_, n, d), rgba: h }
                          );
                        }),
                        (l.opacity = v),
                        (l.multiplyOpacity = function (m, h) {
                    ...
                    (function (l) {
                      ...
                      if (!c.isNode) {
                        ...
                        g &&
                          ...
                          (m = v.createLinearGradient(0, 0, 1, 1)));
                      }
                      l.toColor = function (h) {
                        if (h.match(/#[\da-f]{3,8}/i))
                          switch (h.length) {
                            case 4:
                              return (
                                (_ = parseInt(h.slice(1, 2).repeat(2), 16)),
                                (n = parseInt(h.slice(2, 3).repeat(2), 16)),
                                (d = parseInt(h.slice(3, 4).repeat(2), 16)),
                                t.toColor(_, n, d)
                              );
                            case 5:
                              return (
                                ...
                                (n = parseInt(h.slice(2, 3).repeat(2), 16)),
                                (d = parseInt(h.slice(3, 4).repeat(2), 16)),
                                (f = parseInt(h.slice(4, 5).repeat(2), 16)),
                                t.toColor(_, n, d, f)
                              );
                            case 7:
                              return {
                        ...
                        if (g)
                          return (
                            ...
                            (d = parseInt(g[3])),
                            (f = Math.round(
                              255 * (g[5] === void 0 ? 1 : parseFloat(g[5])),
                            )),
                            t.toColor(_, n, d, f)
                          );
                        if (!v || !m)
                        ...
                        if (
                          (v.fillRect(0, 0, 1, 1),
                          ([_, n, d, f] = v.getImageData(0, 0, 1, 1).data),
                          f !== 255)
                        )
                          throw new Error(
                            'css.toColor: Unsupported css format',
                          );
                        return { rgba: p.toRgba(_, n, d, f), css: h };
                      };
                    })(e || (r.css = e = {})),
                    (function (l) {
                      function v(m, h, g) {
                    ...
                    (function (l) {
                      function v(h, g, b) {
                        ...
                        let x = (g >> 24) & 255,
                          ...
                          O = (g >> 8) & 255,
                          M = o(
                            s.relativeLuminance2(x, T, O),
                            s.relativeLuminance2(L, y, k),
                          );
                        for (; M < b && (x > 0 || T > 0 || O > 0); )
                          ((x -= Math.max(0, Math.ceil(0.1 * x))),
                            (T -= Math.max(0, Math.ceil(0.1 * T))),
                            (O -= Math.max(0, Math.ceil(0.1 * O))),
                            (M = o(
                              s.relativeLuminance2(x, T, O),
                              s.relativeLuminance2(L, y, k),
                            )));
                        return ((x << 24) | (T << 16) | (O << 8) | 255) >>> 0;
                      }
                      function m(h, g, b) {
                        const L = (h >> 24) & 255,
                          y = (h >> 16) & 255,
                        ...
                        for (; M < b && (x < 255 || T < 255 || O < 255); )
                          ((x = Math.min(255, x + Math.ceil(0.1 * (255 - x)))),
                            (T = Math.min(255, T + Math.ceil(0.1 * (255 - T)))),
                      ...
                      ((l.ensureContrastRatio = function (h, g, b) {
                        const L = s.relativeLuminance(h >> 8),
                          y = s.relativeLuminance(g >> 8);
                        if (o(L, y) < b) {
                          if (y < L) {
                            const T = v(h, g, b),
                              O = o(L, s.relativeLuminance(T >> 8));
                            if (O < b) {
                              const M = m(h, g, b);
                              return O > o(L, s.relativeLuminance(M >> 8))
                                ? T
                                : M;
                            }
                            return T;
                          ...
                          const k = m(h, g, b),
                            x = o(L, s.relativeLuminance(k >> 8));
                          if (x < b) {
                            const T = v(h, g, b);
                            return x > o(L, s.relativeLuminance(T >> 8))
                              ? k
                              : T;
                          }
                          return k;
                        ...
                        (l.reduceLuminance = v),
                        (l.increaseLuminance = m),
                        (l.toChannels = function (h) {
                          return [
                            (h >> 24) & 255,
                            (h >> 16) & 255,
                            (h >> 8) & 255,
                        ...
                        (l.toColor = function (h, g, b, L) {
                          return {
                            css: p.toCss(h, g, b, L),
                            rgba: p.toRgba(h, g, b, L),
                          };
                        }));
                    })(t || (r.rgba = t = {})),
                    (r.toPaddedHex = i),
                ...
                8969: (I, r, a) => {
                  ...
                  class g extends c.Disposable {
                    get onScroll() {
                      return (
                        this._onScrollApi ||
                          ...
                          this._onScroll.event((L) => {
                            var y;
                            (y = this._onScrollApi) === null ||
                              y === void 0 ||
                              y.fire(L.position);
                          })),
                    ...
                    set options(L) {
                      for (const y in L) this.optionsService.options[y] = L[y];
                    }
                    constructor(L) {
                      (super(),
                        ...
                        this.register(
                          this._bufferService.onScroll((y) => {
                            (this._onScroll.fire({
                        ...
                        (this._writeBuffer = this.register(
                          new v.WriteBuffer((y, k) =>
                            this._inputHandler.parse(y, k),
                          ),
                        )),
                        this.register(
                          (0, e.forwardEvent)(
                    ...
                    writeSync(L, y) {
                      (this._logService.logLevel <= _.LogLevelEnum.WARN &&
                        ...
                        (h = !0)),
                        this._writeBuffer.writeSync(L, y));
                    }
                    resize(L, y) {
                      isNaN(L) ||
                        isNaN(y) ||
                        ((L = Math.max(L, f.MINIMUM_COLS)),
                        (y = Math.max(y, f.MINIMUM_ROWS)),
                        this._bufferService.resize(L, y));
                    }
                    scroll(L, y = !1) {
                      this._bufferService.scroll(L, y);
                    }
                    scrollLines(L, y, k) {
                      this._bufferService.scrollLines(L, y, k);
                    }
                    scrollPages(L) {
                    ...
                    scrollToLine(L) {
                      const y = L - this._bufferService.buffer.ydisp;
                      y !== 0 && this.scrollLines(y);
                    }
                    registerEscHandler(L, y) {
                      return this._inputHandler.registerEscHandler(L, y);
                    }
                    registerDcsHandler(L, y) {
                      return this._inputHandler.registerDcsHandler(L, y);
                    }
                    registerCsiHandler(L, y) {
                      return this._inputHandler.registerCsiHandler(L, y);
                    }
                    registerOscHandler(L, y) {
                      return this._inputHandler.registerOscHandler(L, y);
                    }
                    _setup() {
                      this._handleWindowsPtyOptionChange();
                    }
                    ...
                    _handleWindowsPtyOptionChange() {
                      ...
                      (y && y.buildNumber !== void 0 && y.buildNumber !== void 0
                        ? (L = y.backend === 'conpty' && y.buildNumber < 21376)
                ...
                8460: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.forwardEvent = r.EventEmitter = void 0),
                ...
                5435: function (I, r, a) {
                        ...
                        var D,
                          ...
                          H =
                            P < 3
                              ? C
                              : E === null
                                ? (E = Object.getOwnPropertyDescriptor(C, w))
                                : E;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          H = Reflect.decorate(M, C, w, E);
                        else
                          for (var U = M.length - 1; U >= 0; U--)
                            (D = M[U]) &&
                              (H =
                                (P < 3 ? D(H) : P > 3 ? D(C, w, H) : D(C, w)) ||
                                H);
                        return (
                          P > 3 && H && Object.defineProperty(C, w, H),
                          H
                        );
                      },
                    _ =
                  ...
                  const n = a(2584),
                    ...
                    b = 131072;
                  function L(M, C) {
                    if (M > 24) return C.setWinLines || !1;
                    switch (M) {
                      case 1:
                        return !!C.restoreWin;
                      case 2:
                  ...
                  var y;
                  (function (M) {
                    ((M[(M.GET_WIN_SIZE_PIXELS = 0)] = 'GET_WIN_SIZE_PIXELS'),
                      (M[(M.GET_CELL_SIZE_PIXELS = 1)] =
                        'GET_CELL_SIZE_PIXELS'));
                  })(y || (r.WindowsOptionsReportType = y = {}));
                  let k = 0;
                  class x extends p.Disposable {
                    getAttrData() {
                    ...
                    constructor(
                      ...
                      (super(),
                        ...
                        (this._coreMouseService = U),
                        (this._unicodeService = W),
                        (this._parser = z),
                        (this._parseBuffer = new Uint32Array(4096)),
                        (this._stringDecoder = new u.StringToUtf32()),
                        (this._utf8Decoder = new u.Utf8ToUtf32()),
                        (this._workCell = new i.CellData()),
                        (this._windowTitle = ''),
                        (this._iconName = ''),
                        (this._windowTitleStack = []),
                        (this._iconNameStack = []),
                        (this._curAttrData = e.DEFAULT_ATTR_DATA.clone()),
                        ...
                        (this._dirtyRowTracker = new T(this._bufferService)),
                        (this._activeBuffer = this._bufferService.buffer),
                        this.register(
                          this._bufferService.buffers.onBufferActivate(
                        ...
                        this._parser.setCsiHandlerFallback((S, R) => {
                          this._logService.debug('Unknown CSI code: ', {
                            identifier: this._parser.identToString(S),
                            params: R.toArray(),
                          });
                        }),
                        ...
                        this._parser.setOscHandlerFallback((S, R, B) => {
                        ...
                        this._parser.setDcsHandlerFallback((S, R, B) => {
                          (R === 'HOOK' && (B = B.toArray()),
                        ...
                        this._parser.setPrintHandler((S, R, B) =>
                          this.print(S, R, B),
                        ),
                        this._parser.registerCsiHandler({ final: '@' }, (S) =>
                          this.insertChars(S),
                        ),
                        ...
                        this._parser.registerCsiHandler({ final: 'A' }, (S) =>
                          this.cursorUp(S),
                        ),
                        this._parser.registerCsiHandler(
                          { intermediates: ' ', final: 'A' },
                          (S) => this.scrollRight(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'B' }, (S) =>
                          this.cursorDown(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'C' }, (S) =>
                          this.cursorForward(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'D' }, (S) =>
                          this.cursorBackward(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'E' }, (S) =>
                          this.cursorNextLine(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'F' }, (S) =>
                          this.cursorPrecedingLine(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'G' }, (S) =>
                          this.cursorCharAbsolute(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'H' }, (S) =>
                          this.cursorPosition(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'I' }, (S) =>
                          this.cursorForwardTab(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'J' }, (S) =>
                          this.eraseInDisplay(S, !1),
                        ),
                        this._parser.registerCsiHandler(
                          { prefix: '?', final: 'J' },
                          (S) => this.eraseInDisplay(S, !0),
                        ),
                        this._parser.registerCsiHandler({ final: 'K' }, (S) =>
                          this.eraseInLine(S, !1),
                        ),
                        this._parser.registerCsiHandler(
                          { prefix: '?', final: 'K' },
                          (S) => this.eraseInLine(S, !0),
                        ),
                        this._parser.registerCsiHandler({ final: 'L' }, (S) =>
                          this.insertLines(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'M' }, (S) =>
                          this.deleteLines(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'P' }, (S) =>
                          this.deleteChars(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'S' }, (S) =>
                          this.scrollUp(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'T' }, (S) =>
                          this.scrollDown(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'X' }, (S) =>
                          this.eraseChars(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'Z' }, (S) =>
                          this.cursorBackwardTab(S),
                        ),
                        this._parser.registerCsiHandler({ final: '`' }, (S) =>
                          this.charPosAbsolute(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'a' }, (S) =>
                          this.hPositionRelative(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'b' }, (S) =>
                          this.repeatPrecedingCharacter(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'c' }, (S) =>
                          this.sendDeviceAttributesPrimary(S),
                        ),
                        this._parser.registerCsiHandler(
                          { prefix: '>', final: 'c' },
                          (S) => this.sendDeviceAttributesSecondary(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'd' }, (S) =>
                          this.linePosAbsolute(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'e' }, (S) =>
                          this.vPositionRelative(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'f' }, (S) =>
                          this.hVPosition(S),
                        ),
                        ...
                        this._parser.registerCsiHandler(
                          { prefix: '?', final: 'l' },
                          (S) => this.resetModePrivate(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'm' }, (S) =>
                          this.charAttributes(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'n' }, (S) =>
                          this.deviceStatus(S),
                        ),
                        this._parser.registerCsiHandler(
                          { prefix: '?', final: 'n' },
                          (S) => this.deviceStatusPrivate(S),
                        ),
                        this._parser.registerCsiHandler(
                        ...
                        this._parser.registerCsiHandler(
                          ...
                          (S) => this.setCursorStyle(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'r' }, (S) =>
                          this.setScrollRegion(S),
                        ),
                        this._parser.registerCsiHandler({ final: 's' }, (S) =>
                          this.saveCursor(S),
                        ),
                        this._parser.registerCsiHandler({ final: 't' }, (S) =>
                          this.windowOptions(S),
                        ),
                        this._parser.registerCsiHandler({ final: 'u' }, (S) =>
                          this.restoreCursor(S),
                        ),
                        this._parser.registerCsiHandler(
                          { intermediates: "'", final: '}' },
                          (S) => this.insertColumns(S),
                        ),
                        this._parser.registerCsiHandler(
                          { intermediates: "'", final: '~' },
                          (S) => this.deleteColumns(S),
                        ),
                        this._parser.registerCsiHandler(
                          { intermediates: '"', final: 'q' },
                          (S) => this.selectProtected(S),
                        ),
                        this._parser.registerCsiHandler(
                          { intermediates: '$', final: 'p' },
                          (S) => this.requestMode(S, !0),
                        ),
                        this._parser.registerCsiHandler(
                          { prefix: '?', intermediates: '$', final: 'p' },
                          (S) => this.requestMode(S, !1),
                        ),
                        ...
                        this._parser.registerOscHandler(
                          0,
                          new v.OscHandler(
                            (S) => (this.setTitle(S), this.setIconName(S), !0),
                          ),
                        ),
                        this._parser.registerOscHandler(
                          1,
                          new v.OscHandler((S) => this.setIconName(S)),
                        ),
                        this._parser.registerOscHandler(
                          2,
                          new v.OscHandler((S) => this.setTitle(S)),
                        ),
                        this._parser.registerOscHandler(
                          4,
                          new v.OscHandler((S) =>
                            this.setOrReportIndexedColor(S),
                          ),
                        ),
                        this._parser.registerOscHandler(
                          8,
                          new v.OscHandler((S) => this.setHyperlink(S)),
                        ),
                        this._parser.registerOscHandler(
                          10,
                          new v.OscHandler((S) => this.setOrReportFgColor(S)),
                        ),
                        this._parser.registerOscHandler(
                          11,
                          new v.OscHandler((S) => this.setOrReportBgColor(S)),
                        ),
                        this._parser.registerOscHandler(
                          12,
                          new v.OscHandler((S) =>
                            this.setOrReportCursorColor(S),
                          ),
                        ),
                        this._parser.registerOscHandler(
                          104,
                          new v.OscHandler((S) => this.restoreIndexedColor(S)),
                        ),
                        this._parser.registerOscHandler(
                          110,
                          new v.OscHandler((S) => this.restoreFgColor(S)),
                        ),
                        this._parser.registerOscHandler(
                          111,
                          new v.OscHandler((S) => this.restoreBgColor(S)),
                        ),
                        this._parser.registerOscHandler(
                          112,
                          new v.OscHandler((S) => this.restoreCursorColor(S)),
                        ),
                      ...
                      for (const S in d.CHARSETS)
                        (this._parser.registerEscHandler(
                          { intermediates: '(', final: S },
                          () => this.selectCharset('(' + S),
                        ),
                          this._parser.registerEscHandler(
                            { intermediates: ')', final: S },
                            () => this.selectCharset(')' + S),
                      ...
                      (this._parser.registerEscHandler(
                        ...
                        this._parser.setErrorHandler(
                          (S) => (
                            this._logService.error('Parsing error: ', S),
                            S
                          ),
                        ),
                        this._parser.registerDcsHandler(
                          { intermediates: '$', final: 'q' },
                          new m.DcsHandler((S, R) =>
                            this.requestStatusString(S, R),
                          ),
                        ));
                    }
                    _preserveStack(C, w, E, D) {
                    ...
                    _logSlowResolvingAsync(C) {
                      this._logService.logLevel <= l.LogLevelEnum.WARN &&
                        Promise.race([
                          C,
                          new Promise((w, E) =>
                    ...
                    parse(C, w) {
                      let E,
                        ...
                        H = 0;
                      const U = this._parseStack.paused;
                      if (U) {
                        if (
                        ...
                        ((D = this._parseStack.cursorStartX),
                          (P = this._parseStack.cursorStartY),
                          (this._parseStack.paused = !1),
                          C.length > b && (H = this._parseStack.position + b));
                      }
                      if (
                        (this._logService.logLevel <= l.LogLevelEnum.DEBUG &&
                          this._logService.debug(
                            'parsing data' +
                              (typeof C == 'string'
                                ? ` "${C}"`
                                : ` "${Array.prototype.map.call(C, (W) => String.fromCharCode(W)).join('')}"`),
                            typeof C == 'string'
                              ? C.split('').map((W) => W.charCodeAt(0))
                              : C,
                          ),
                        ...
                        U || this._dirtyRowTracker.clearRange(),
                        C.length > b)
                      )
                        for (let W = H; W < C.length; W += b) {
                          const z = W + b < C.length ? W + b : C.length,
                            S =
                              typeof C == 'string'
                          ...
                          if ((E = this._parser.parse(this._parseBuffer, S)))
                            return (
                              this._preserveStack(D, P, S, W),
                        ...
                        if ((E = this._parser.parse(this._parseBuffer, W)))
                          return (
                            this._preserveStack(D, P, W, 0),
                            this._logSlowResolvingAsync(E),
                            E
                          );
                      }
                      ((this._activeBuffer.x === D &&
                        this._activeBuffer.y === P) ||
                    ...
                    print(C, w, E) {
                      ...
                      const H = this._charsetService.charset,
                        U = this._optionsService.rawOptions.screenReaderMode,
                        W = this._bufferService.cols,
                        z = this._coreService.decPrivateModes.wraparound,
                        S = this._coreService.modes.insertMode,
                        R = this._curAttrData;
                      ...
                      for (let A = w; A < E; ++A) {
                        if (
                          ((D = C[A]),
                          (P = this._unicodeService.wcwidth(D)),
                          D < 127 && H)
                        ) {
                          const N = H[String.fromCharCode(D)];
                          N && (D = N.charCodeAt(0));
                        }
                        if (
                          (U &&
                            this._onA11yChar.fire(
                              (0, u.stringFromCodePoint)(D),
                            ),
                          ...
                          if (this._activeBuffer.x + P - 1 >= W) {
                            if (z) {
                              for (; this._activeBuffer.x < W; )
                                B.setCellFromCodePoint(
                                  this._activeBuffer.x++,
                                  0,
                                  1,
                          ...
                          if (
                            (S &&
                              (B.insertCells(
                                this._activeBuffer.x,
                                P,
                                this._activeBuffer.getNullCell(R),
                                R,
                              ),
                              B.getWidth(W - 1) === 2 &&
                                B.setCellFromCodePoint(
                          ...
                          B.getWidth(this._activeBuffer.x - 1)
                            ? B.addCodepointToCell(this._activeBuffer.x - 1, D)
                            : B.addCodepointToCell(this._activeBuffer.x - 2, D);
                      }
                      (E - w > 0 &&
                        (B.loadCell(this._activeBuffer.x - 1, this._workCell),
                        this._workCell.getWidth() === 2 ||
                    ...
                    registerCsiHandler(C, w) {
                      return C.final !== 't' || C.prefix || C.intermediates
                        ? this._parser.registerCsiHandler(C, w)
                        : this._parser.registerCsiHandler(
                            C,
                            (E) =>
                              !L(
                    ...
                    backspace() {
                      ...
                      if (
                        ...
                        w.hasWidth(this._activeBuffer.x) &&
                          !w.hasContent(this._activeBuffer.x) &&
                          this._activeBuffer.x--;
                      }
                      ...
                      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                        this._coreService.decPrivateModes.origin
                          ? ((this._activeBuffer.x = C),
                            (this._activeBuffer.y =
                              this._activeBuffer.scrollTop + w))
                          : ((this._activeBuffer.x = C),
                    ...
                    cursorUp(C) {
                      ...
                      return (
                        w >= 0
                          ? this._moveCursor(0, -Math.min(w, C.params[0] || 1))
                    ...
                    _eraseInBufferLine(C, w, E, D = !1, P = !1) {
                      const H = this._activeBuffer.lines.get(
                        this._activeBuffer.ybase + C,
                      );
                      (H.replaceCells(
                        w,
                        E,
                        ...
                        case 1:
                          for (
                            E = this._activeBuffer.y,
                              ...
                              this._activeBuffer.x + 1 >=
                                this._bufferService.cols &&
                                (this._activeBuffer.lines.get(E + 1).isWrapped =
                                  !1);
                            E--;
                          )
                            this._resetBufferLine(E, w);
                    ...
                    insertLines(C) {
                      ...
                      const E = this._activeBuffer.ybase + this._activeBuffer.y,
                        ...
                        P =
                          ...
                          1;
                      for (; w--; )
                        (this._activeBuffer.lines.splice(P - 1, 1),
                        ...
                        switch (C.params[w]) {
                          ...
                          case 1047:
                            (this._bufferService.buffers.activateNormalBuffer(),
                              C.params[w] === 1049 && this.restoreCursor(),
                              (this._coreService.isCursorInitialized = !0),
                              this._onRequestRefreshRows.fire(
                                0,
                                this._bufferService.rows - 1,
                    ...
                    requestMode(C, w) {
                      const E = this._coreService.decPrivateModes,
                        { activeProtocol: D, activeEncoding: P } =
                          this._coreMouseService,
                        H = this._coreService,
                        { buffers: U, cols: W } = this._bufferService,
                        { active: z, alt: S } = U,
                    ...
                    _updateAttrColor(C, w, E, D, P) {
                      return (
                        w === 2
                          ? ((C |= 50331648),
                            (C &= -16777216),
                            (C |= o.AttributeData.fromColorRGB([E, D, P])))
                          : w === 5 &&
                            ((C &= -50331904), (C |= 33554432 | (255 & E))),
                        C
                      );
                    }
                    _extractColor(C, w, E) {
                      ...
                      do {
                        if (
                          ((D[H + P] = C.params[w + H]), C.hasSubParams(w + H))
                        ) {
                          const U = C.getSubParams(w + H);
                          let W = 0;
                          do (D[1] === 5 && (P = 1), (D[H + W + 1 + P] = U[W]));
                          while (++W < U.length && W + H + 1 + P < D.length);
                          break;
                        }
                        if (
                          (D[1] === 5 && H + P >= 2) ||
                          ...
                          break;
                        D[1] && (P = 1);
                      } while (++H + w < C.length && H + P < D.length);
                      for (let U = 2; U < D.length; ++U)
                        D[U] === -1 && (D[U] = 0);
                      switch (D[0]) {
                        case 38:
                    ...
                    _processUnderline(C, w) {
                      ((w.extended = w.extended.clone()),
                        (!~C || C > 5) && (C = 1),
                        (w.extended.underlineStyle = C),
                        (w.fg |= 268435456),
                        C === 0 && (w.fg &= -268435457),
                        w.updateExtended());
                    }
                    _processSGR0(C) {
                      ((C.fg = e.DEFAULT_ATTR_DATA.fg),
                        (C.bg = e.DEFAULT_ATTR_DATA.bg),
                    ...
                    setScrollRegion(C) {
                      ...
                      return (
                        (C.length < 2 ||
                          (E = C.params[1]) > this._bufferService.rows ||
                          E === 0) &&
                          (E = this._bufferService.rows),
                        E > w &&
                    ...
                    setOrReportIndexedColor(C) {
                      ...
                      for (; E.length > 1; ) {
                        ...
                        if (/^\d+$/.exec(D)) {
                          const H = parseInt(D);
                          if (O(H))
                            if (P === '?') w.push({ type: 0, index: H });
                            else {
                              const U = (0, h.parseColor)(P);
                              U && w.push({ type: 1, index: H, color: U });
                            }
                        }
                      }
                    ...
                    _createHyperlink(C, w) {
                      ...
                      const E = C.split(':');
                      let D;
                      const P = E.findIndex((H) => H.startsWith('id='));
                      return (
                        P !== -1 && (D = E[P].slice(3) || void 0),
                        (this._curAttrData.extended =
                          this._curAttrData.extended.clone()),
                        (this._curAttrData.extended.urlId =
                          this._oscLinkService.registerLink({ id: D, uri: w })),
                    ...
                    _setOrReportSpecialColor(C, w) {
                      ...
                      for (
                        let D = 0;
                        D < E.length && !(w >= this._specialColors.length);
                        ++D, ++w
                      )
                        if (E[D] === '?')
                          this._onColor.fire([
                            { type: 0, index: this._specialColors[w] },
                          ]);
                        else {
                          const P = (0, h.parseColor)(E[D]);
                          P &&
                            this._onColor.fire([
                              {
                                type: 1,
                                index: this._specialColors[w],
                                color: P,
                              },
                            ]);
                        }
                    ...
                    restoreIndexedColor(C) {
                      ...
                      for (let D = 0; D < E.length; ++D)
                        if (/^\d+$/.exec(E[D])) {
                          const P = parseInt(E[D]);
                          O(P) && w.push({ type: 2, index: P });
                        }
                      return (w.length && this._onColor.fire(w), !0);
                    }
                    restoreFgColor(C) {
                    ...
                    selectCharset(C) {
                      return C.length !== 2
                        ...
                        : (C[0] === '/' ||
                            this._charsetService.setgCharset(
                              g[C[0]],
                              d.CHARSETS[C[1]] || d.DEFAULT_CHARSET,
                            ),
                          !0);
                    }
                    index() {
                    ...
                    screenAlignmentPattern() {
                      ...
                      for (let w = 0; w < this._bufferService.rows; ++w) {
                        const E =
                            this._activeBuffer.ybase + this._activeBuffer.y + w,
                          D = this._activeBuffer.lines.get(E);
                        D && (D.fill(C), (D.isWrapped = !1));
                      }
                      return (
                  ...
                  let T = class {
                    ...
                    markDirty(M) {
                      M < this.start
                        ? (this.start = M)
                        : M > this.end && (this.end = M);
                    }
                    markRangeDirty(M, C) {
                      (M > C && ((k = M), (M = C), (C = k)),
                        M < this.start && (this.start = M),
                ...
                844: (I, r) => {
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.disposeArray = a),
                    (r.getDisposeArrayDisposable = function (c) {
                      return { dispose: () => a(c) };
                    }));
                },
                1505: (I, r) => {
                  ...
                  ((r.TwoKeyMap = a),
                    (r.FourKeyMap = class {
                      ...
                      set(c, _, n, d, f) {
                        (this._data.get(c, _) || this._data.set(c, _, new a()),
                          this._data.get(c, _).set(n, d, f));
                      }
                      get(c, _, n, d) {
                        var f;
                        return (f = this._data.get(c, _)) === null ||
                          f === void 0
                          ? void 0
                          : f.get(n, d);
                      }
                ...
                6106: (I, r) => {
                  ...
                  r.SortedList = class {
                    ...
                    insert(c) {
                      this._array.length !== 0
                        ? ((a = this._search(this._getKey(c))),
                          this._array.splice(a, 0, c))
                        : this._array.push(c);
                    }
                    delete(c) {
                      ...
                      for (; n >= _; ) {
                        ...
                        if (f > c) n = d - 1;
                          ...
                          if (!(f < c)) {
                            for (
                              ;
                              d > 0 && this._getKey(this._array[d - 1]) === c;
                            )
                              d--;
                            return d;
                          }
                ...
                7226: (I, r, a) => {
                      ...
                      for (; this._i < this._tasks.length; ) {
                        if (
                          ...
                          return (
                            e - p < -20 &&
                              console.warn(
                                `task queue exceeded allotted deadline by ${Math.abs(Math.round(e - p))}ms`,
                              ),
                            void this._start()
                          );
                        e = s;
                  ...
                  class n extends _ {
                    ...
                    _createDeadline(f) {
                      const p = Date.now() + f;
                      return {
                        timeRemaining: () => Math.max(0, p - Date.now()),
                      };
                    }
                  }
                  ((r.PriorityTaskQueue = n),
                    (r.IdleTaskQueue =
                      !c.isNode && 'requestIdleCallback' in window
                        ? class extends _ {
                            _requestCallback(d) {
                ...
                9282: (I, r, a) => {
                  ...
                  r.updateWindowsModeWrappedState = function (_) {
                    const n = _.buffer.lines.get(
                      ...
                      d = n?.get(_.cols - 1),
                      f = _.buffer.lines.get(_.buffer.ybase + _.buffer.y);
                    f &&
                      d &&
                      (f.isWrapped =
                        d[c.CHAR_DATA_CODE_INDEX] !== c.NULL_CELL_CODE &&
                        d[c.CHAR_DATA_CODE_INDEX] !== c.WHITESPACE_CELL_CODE);
                  };
                },
                3734: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.Buffer = class {
                      constructor(t, i, o) {
                        ((this._hasScrollback = t),
                          ...
                          (this.markers = []),
                          (this._nullCell = p.CellData.fromCharData([
                            0,
                            u.NULL_CELL_CHAR,
                            u.NULL_CELL_WIDTH,
                            u.NULL_CELL_CODE,
                          ])),
                          (this._whitespaceCell = p.CellData.fromCharData([
                            0,
                      ...
                      getNullCell(t) {
                        return (
                          t
                            ? ((this._nullCell.fg = t.fg),
                              (this._nullCell.bg = t.bg),
                              (this._nullCell.extended = t.extended))
                            : ((this._nullCell.fg = 0),
                              (this._nullCell.bg = 0),
                      ...
                      getWhitespaceCell(t) {
                        return (
                          t
                            ? ((this._whitespaceCell.fg = t.fg),
                              (this._whitespaceCell.bg = t.bg),
                              (this._whitespaceCell.extended = t.extended))
                      ...
                      _getCorrectBufferLength(t) {
                        ...
                        const i =
                          t + this._optionsService.rawOptions.scrollback;
                      ...
                      resize(t, i) {
                        ...
                        if (
                          (v > this.lines.maxLength &&
                            (this.lines.maxLength = v),
                          this.lines.length > 0)
                        ) {
                          if (this._cols < t)
                            for (let h = 0; h < this.lines.length; h++)
                              l += +this.lines.get(h).resize(t, o);
                          let m = 0;
                          if (this._rows < i)
                            for (let h = this._rows; h < i; h++)
                              this.lines.length < i + this.ybase &&
                                (this._optionsService.rawOptions.windowsMode ||
                                this._optionsService.rawOptions.windowsPty
                                  .backend !== void 0 ||
                                this._optionsService.rawOptions.windowsPty
                                  .buildNumber !== void 0
                                  ? this.lines.push(new d.BufferLine(t, o))
                                  : this.ybase > 0 &&
                                      this.lines.length <=
                                        this.ybase + this.y + m + 1
                                    ? (this.ybase--,
                                      m++,
                          ...
                          if (v < this.lines.maxLength) {
                            ...
                            (h > 0 &&
                              (this.lines.trimStart(h),
                              (this.ybase = Math.max(this.ybase - h, 0)),
                              (this.ydisp = Math.max(this.ydisp - h, 0)),
                              (this.savedY = Math.max(this.savedY - h, 0))),
                              (this.lines.maxLength = v));
                          }
                          ((this.x = Math.min(this.x, t - 1)),
                            (this.y = Math.min(this.y, i - 1)),
                            m && (this.y += m),
                            (this.savedX = Math.min(this.savedX, t - 1)),
                            (this.scrollTop = 0));
                        }
                        if (
                          ((this.scrollBottom = i - 1),
                          this._isReflowEnabled &&
                            (this._reflow(t, i), this._cols > t))
                        )
                          for (let m = 0; m < this.lines.length; m++)
                            l += +this.lines.get(m).resize(t, o);
                        ((this._cols = t),
                          (this._rows = i),
                          this._memoryCleanupQueue.clear(),
                          l > 0.1 * this.lines.length &&
                            ((this._memoryCleanupPosition = 0),
                      ...
                      _batchedMemoryCleanup() {
                        ...
                        this._memoryCleanupPosition >= this.lines.length &&
                          ((this._memoryCleanupPosition = 0), (t = !1));
                        let i = 0;
                        for (
                          ;
                          this._memoryCleanupPosition < this.lines.length;
                      ...
                      _reflow(t, i) {
                        this._cols !== t &&
                          (t > this._cols
                            ? this._reflowLarger(t, i)
                            : this._reflowSmaller(t, i));
                      }
                      _reflowLarger(t, i) {
                        const o = (0, f.reflowLargerGetLinesToRemove)(
                          this.lines,
                          this._cols,
                          t,
                          this.ybase + this.y,
                        ...
                        if (o.length > 0) {
                          const l = (0, f.reflowLargerCreateNewLayout)(
                            this.lines,
                            o,
                          );
                          ((0, f.reflowLargerApplyNewLayout)(
                            this.lines,
                            l.layout,
                          ),
                      ...
                      _reflowLargerAdjustViewport(t, i, o) {
                        ...
                        for (; v-- > 0; )
                          this.ybase === 0
                            ? (this.y > 0 && this.y--,
                              this.lines.length < i &&
                                this.lines.push(new d.BufferLine(t, l)))
                      ...
                      _reflowSmaller(t, i) {
                        ...
                        for (let m = this.lines.length - 1; m >= 0; m--) {
                          ...
                          if (!h || (!h.isWrapped && h.getTrimmedLength() <= t))
                            continue;
                          const g = [h];
                          for (; h.isWrapped && m > 0; )
                            ((h = this.lines.get(--m)), g.unshift(h));
                          const b = this.ybase + this.y;
                          if (b >= m && b < m + g.length) continue;
                          const L = g[g.length - 1].getTrimmedLength(),
                            y = (0, f.reflowSmallerGetNewLineLengths)(
                              g,
                              this._cols,
                              t,
                            ),
                          ...
                          x =
                            this.ybase === 0 && this.y !== this.lines.length - 1
                              ? Math.max(0, this.y - this.lines.maxLength + k)
                              : Math.max(
                                  0,
                                  this.lines.length - this.lines.maxLength + k,
                                );
                          const T = [];
                          for (let D = 0; D < k; D++) {
                            const P = this.getBlankLine(
                              d.DEFAULT_ATTR_DATA,
                              !0,
                            );
                            T.push(P);
                          ...
                          (T.length > 0 &&
                            (l.push({ start: m + g.length + v, newLines: T }),
                            (v += T.length)),
                            g.push(...T));
                          let O = y.length - 1,
                            M = y[O];
                          ...
                          for (; C >= 0; ) {
                            ...
                            if (g[O] === void 0) break;
                            if (
                              (g[O].copyCellsFrom(g[C], w - D, M - D, D, !0),
                              (M -= D),
                              M === 0 && (O--, (M = y[O])),
                              (w -= D),
                              w === 0)
                              ...
                              C--;
                              const P = Math.max(C, 0);
                              w = (0, f.getWrappedLineTrimmedLength)(
                                g,
                                P,
                                this._cols,
                              );
                          ...
                          for (
                            ...
                            if (y && y.start > b + k) {
                              for (let M = y.newLines.length - 1; M >= 0; M--)
                                this.lines.set(O--, y.newLines[M]);
                              (O++,
                                m.push({
                                  index: b + 1,
                                  amount: y.newLines.length,
                                }),
                                (k += y.newLines.length),
                                (y = l[++L]));
                            } else this.lines.set(O, h[b--]);
                          let x = 0;
                          for (let O = m.length - 1; O >= 0; O--)
                            ((m[O].index += x),
                              this.lines.onInsertEmitter.fire(m[O]),
                              (x += m[O].amount));
                          const T = Math.max(0, g + v - this.lines.maxLength);
                          T > 0 && this.lines.onTrimEmitter.fire(T);
                        }
                      }
                      ...
                      setupTabStops(t) {
                        for (
                          t != null
                            ...
                            : ((this.tabs = {}), (t = 0));
                          t < this._cols;
                          t += this._optionsService.rawOptions.tabStopWidth
                        )
                          this.tabs[t] = !0;
                      }
                      prevStop(t) {
                        ...
                        return (
                          ...
                          i.register(
                            this.lines.onDelete((o) => {
                              (i.line >= o.index &&
                                i.line < o.index + o.amount &&
                                i.dispose(),
                                i.line > o.index && (i.line -= o.amount));
                            }),
                          ),
                          i.register(i.onDispose(() => this._removeMarker(i))),
                          i
                        );
                      }
                      _removeMarker(t) {
                ...
                8437: (I, r, a) => {
                  ...
                  class p {
                    ...
                    set(e, s) {
                      ((this._data[3 * e + 1] = s[n.CHAR_DATA_ATTR_INDEX]),
                        s[n.CHAR_DATA_CHAR_INDEX].length > 1
                          ? ((this._combined[e] = s[1]),
                            (this._data[3 * e + 0] =
                              2097152 | e | (s[n.CHAR_DATA_WIDTH_INDEX] << 22)))
                          : (this._data[3 * e + 0] =
                    ...
                    loadCell(e, s) {
                      return (
                        (f = 3 * e),
                        (s.content = this._data[f + 0]),
                        (s.fg = this._data[f + 1]),
                        (s.bg = this._data[f + 2]),
                        2097152 & s.content &&
                          (s.combinedData = this._combined[e]),
                        268435456 & s.bg &&
                          (s.extended = this._extendedAttrs[e]),
                        s
                      );
                    }
                    setCell(e, s) {
                      (2097152 & s.content &&
                        (this._combined[e] = s.combinedData),
                        268435456 & s.bg &&
                          (this._extendedAttrs[e] = s.extended),
                        (this._data[3 * e + 0] = s.content),
                        (this._data[3 * e + 1] = s.fg),
                        (this._data[3 * e + 2] = s.bg));
                    }
                    setCellFromCodePoint(e, s, t, i, o, l) {
                      (268435456 & o && (this._extendedAttrs[e] = l),
                        (this._data[3 * e + 0] = s | (t << 22)),
                        (this._data[3 * e + 1] = i),
                        (this._data[3 * e + 2] = o));
                    }
                    addCodepointToCell(e, s) {
                      ...
                      2097152 & t
                        ? (this._combined[e] += (0, d.stringFromCodePoint)(s))
                        : (2097151 & t
                            ? ((this._combined[e] =
                      ...
                      if (
                        ((e %= this.length) &&
                          ...
                          this.setCellFromCodePoint(
                            ...
                            i?.fg || 0,
                            i?.bg || 0,
                            i?.extended || new c.ExtendedAttrs(),
                          ),
                        s < this.length - e)
                      ) {
                        const o = new _.CellData();
                        for (let l = this.length - e - s - 1; l >= 0; --l)
                          this.setCell(e + s + l, this.loadCell(e + l, o));
                        for (let l = 0; l < s; ++l) this.setCell(e + l, t);
                      } else
                        for (let o = e; o < this.length; ++o)
                          this.setCell(o, t);
                    ...
                    deleteCells(e, s, t, i) {
                      if (((e %= this.length), s < this.length - e)) {
                        const o = new _.CellData();
                        for (let l = 0; l < this.length - e - s; ++l)
                          this.setCell(e + l, this.loadCell(e + s + l, o));
                        for (let l = this.length - s; l < this.length; ++l)
                          this.setCell(l, t);
                      } else
                        for (let o = e; o < this.length; ++o)
                          this.setCell(o, t);
                    ...
                    resize(e, s) {
                      ...
                      return (
                        (this.length = e),
                        4 * t * 2 < this._data.buffer.byteLength
                      );
                    }
                    cleanupMemory() {
                      if (
                    ...
                    copyFrom(e) {
                      (this.length !== e.length
                        ...
                        (this.length = e.length),
                        (this._combined = {}));
                      for (const s in e._combined)
                        this._combined[s] = e._combined[s];
                      this._extendedAttrs = {};
                      for (const s in e._extendedAttrs)
                        this._extendedAttrs[s] = e._extendedAttrs[s];
                    ...
                    clone() {
                      ...
                      for (const s in this._combined)
                        e._combined[s] = this._combined[s];
                      for (const s in this._extendedAttrs)
                        e._extendedAttrs[s] = this._extendedAttrs[s];
                    ...
                    copyCellsFrom(e, s, t, i, o) {
                      ...
                      if (o)
                        for (let m = i - 1; m >= 0; m--) {
                          for (let h = 0; h < 3; h++)
                            this._data[3 * (t + m) + h] = l[3 * (s + m) + h];
                          268435456 & l[3 * (s + m) + 2] &&
                            (this._extendedAttrs[t + m] =
                              e._extendedAttrs[s + m]);
                        }
                      else
                        for (let m = 0; m < i; m++) {
                          for (let h = 0; h < 3; h++)
                    ...
                    translateToString(e = !1, s = 0, t = this.length) {
                      ...
                      let i = '';
                      for (; s < t; ) {
                        const o = this._data[3 * s + 0],
                          l = 2097151 & o;
                        ((i +=
                          2097152 & o
                            ? this._combined[s]
                            : l
                              ? (0, d.stringFromCodePoint)(l)
                ...
                4634: (I, r) => {
                  function a(c, _, n) {
                    ...
                    const d =
                        !c[_].hasContent(n - 1) && c[_].getWidth(n - 1) === 1,
                      f = c[_ + 1].getWidth(0) === 2;
                    return d && f ? n - 1 : n;
                  }
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.getWrappedLineTrimmedLength =
                      ...
                      r.reflowLargerGetLinesToRemove =
                        void 0),
                    (r.reflowLargerGetLinesToRemove = function (c, _, n, d, f) {
                      const p = [];
                      for (let u = 0; u < c.length - 1; u++) {
                        ...
                        for (; l < t.length; ) {
                          ...
                          (t[i].copyCellsFrom(t[l], v, o, L, !1),
                            ...
                            o === 0 &&
                              i !== 0 &&
                              t[i - 1].getWidth(n - 1) === 2 &&
                              (t[i].copyCellsFrom(t[i - 1], n - 1, o++, 1, !1),
                              t[i - 1].setCell(n - 1, f)));
                        }
                        ...
                        for (
                          let h = t.length - 1;
                          h > 0 && (h > i || t[h].getTrimmedLength() === 0);
                          h--
                        )
                          m++;
                        (m > 0 && (p.push(u + t.length - m), p.push(m)),
                          (u += t.length - 1));
                      }
                      return p;
                    }),
                    (r.reflowLargerCreateNewLayout = function (c, _) {
                      ...
                      for (let u = 0; u < c.length; u++)
                        if (f === u) {
                          const e = _[++d];
                          (c.onDeleteEmitter.fire({ index: u - p, amount: e }),
                            (u += e - 1),
                            (p += e),
                            (f = _[++d]));
                        } else n.push(u);
                    ...
                    (r.reflowSmallerGetNewLineLengths = function (c, _, n) {
                      const d = [],
                        f = c.map((s, t) => a(c, t, _)).reduce((s, t) => s + t);
                      let p = 0,
                        u = 0,
                        e = 0;
                      for (; e < f; ) {
                ...
                5295: (I, r, a) => {
                  ...
                  class d extends _.Disposable {
                    ...
                    resize(p, u) {
                      (this._normal.resize(p, u),
                        this._alt.resize(p, u),
                        this.setupTabStops(p));
                    }
                    setupTabStops(p) {
                      (this._normal.setupTabStops(p),
                        this._alt.setupTabStops(p));
                    }
                  }
                  r.BufferSet = d;
                },
                511: (I, r, a) => {
                  ...
                  class d extends n.AttributeData {
                    ...
                    getChars() {
                      return 2097152 & this.content
                        ...
                        : 2097151 & this.content
                          ? (0, c.stringFromCodePoint)(2097151 & this.content)
                          : '';
                    }
                    getCode() {
                    ...
                    setFromCharData(p) {
                      ((this.fg = p[_.CHAR_DATA_ATTR_INDEX]), (this.bg = 0));
                      let u = !1;
                      if (p[_.CHAR_DATA_CHAR_INDEX].length > 2) u = !0;
                      else if (p[_.CHAR_DATA_CHAR_INDEX].length === 2) {
                        const e = p[_.CHAR_DATA_CHAR_INDEX].charCodeAt(0);
                        if (55296 <= e && e <= 56319) {
                          const s = p[_.CHAR_DATA_CHAR_INDEX].charCodeAt(1);
                          56320 <= s && s <= 57343
                            ? (this.content =
                                (1024 * (e - 55296) + s - 56320 + 65536) |
                                (p[_.CHAR_DATA_WIDTH_INDEX] << 22))
                            : (u = !0);
                        } else u = !0;
                      } else
                        this.content =
                          p[_.CHAR_DATA_CHAR_INDEX].charCodeAt(0) |
                          (p[_.CHAR_DATA_WIDTH_INDEX] << 22);
                      u &&
                        ((this.combinedData = p[_.CHAR_DATA_CHAR_INDEX]),
                        (this.content =
                          2097152 | (p[_.CHAR_DATA_WIDTH_INDEX] << 22)));
                    }
                    getAsCharData() {
                      return [
                        this.fg,
...
`),
                ...
                7399: (I, r, a) => {
                  ...
                  r.evaluateKeyboardEvent = function (n, d, f, p) {
                    const u = { type: 0, cancel: !1, key: void 0 },
                      e =
                        (n.shiftKey ? 1 : 0) |
                        (n.altKey ? 2 : 0) |
                        (n.ctrlKey ? 4 : 0) |
                    ...
                    switch (n.keyCode) {
                      case 0:
                        n.key === 'UIKeyInputUpArrow'
                          ? (u.key = d ? c.C0.ESC + 'OA' : c.C0.ESC + '[A')
                          : n.key === 'UIKeyInputLeftArrow'
                            ? (u.key = d ? c.C0.ESC + 'OD' : c.C0.ESC + '[D')
                            : n.key === 'UIKeyInputRightArrow'
                              ? (u.key = d ? c.C0.ESC + 'OC' : c.C0.ESC + '[C')
                              : n.key === 'UIKeyInputDownArrow' &&
                                (u.key = d ? c.C0.ESC + 'OB' : c.C0.ESC + '[B');
                        break;
                      case 8:
                        if (n.altKey) {
                      ...
                      case 9:
                        ...
                        break;
                      case 13:
                        ((u.key = n.altKey ? c.C0.ESC + c.C0.CR : c.C0.CR),
                          (u.cancel = !0));
                        break;
                      case 27:
                        ((u.key = c.C0.ESC),
                          n.altKey && (u.key = c.C0.ESC + c.C0.ESC),
                          (u.cancel = !0));
                        break;
                      case 37:
                        if (n.metaKey) break;
                        e
                          ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'D'),
                            u.key === c.C0.ESC + '[1;3D' &&
                              (u.key = c.C0.ESC + (f ? 'b' : '[1;5D')))
                          : (u.key = d ? c.C0.ESC + 'OD' : c.C0.ESC + '[D');
                        break;
                      case 39:
                        if (n.metaKey) break;
                        e
                          ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'C'),
                            u.key === c.C0.ESC + '[1;3C' &&
                              (u.key = c.C0.ESC + (f ? 'f' : '[1;5C')))
                          : (u.key = d ? c.C0.ESC + 'OC' : c.C0.ESC + '[C');
                        break;
                      case 38:
                        if (n.metaKey) break;
                        e
                          ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'A'),
                            f ||
                              u.key !== c.C0.ESC + '[1;3A' ||
                              (u.key = c.C0.ESC + '[1;5A'))
                          : (u.key = d ? c.C0.ESC + 'OA' : c.C0.ESC + '[A');
                      ...
                      default:
                        if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey)
                          if ((f && !p) || !n.altKey || n.metaKey)
                            ...
                            !n.metaKey
                              ? n.key &&
                                ...
                                : n.key &&
                                  n.ctrlKey &&
                                  (n.key === '_' && (u.key = c.C0.US),
                                  n.key === '@' && (u.key = c.C0.NUL))
                              : n.keyCode === 65 && (u.type = 1);
                          else {
                            const s = _[n.keyCode],
                              t = s?.[n.shiftKey ? 1 : 0];
                            if (t) u.key = c.C0.ESC + t;
                              ...
                              u.key = c.C0.ESC + (n.ctrlKey ? c.C0.NUL : ' ');
                            else if (
                              n.key === 'Dead' &&
                              n.code.startsWith('Key')
                            ) {
                              let i = n.code.slice(3, 4);
                              (n.shiftKey || (i = i.toLowerCase()),
                                (u.key = c.C0.ESC + i),
                                (u.cancel = !0));
                            }
                          }
                          ...
                          n.keyCode >= 65 && n.keyCode <= 90
                            ? (u.key = String.fromCharCode(n.keyCode - 64))
                            : n.keyCode === 32
                              ? (u.key = c.C0.NUL)
                              : n.keyCode >= 51 && n.keyCode <= 55
                                ? (u.key = String.fromCharCode(
                                    n.keyCode - 51 + 27,
                                  ))
                                : n.keyCode === 56
                                  ? (u.key = c.C0.DEL)
                        ...
                        if (this._interim) {
                          ...
                          (56320 <= f && f <= 57343
                            ? (c[n++] =
                                ...
                                56320 +
                                65536)
                            : ((c[n++] = this._interim), (c[n++] = f)),
                            (this._interim = 0));
                        }
                        for (let f = d; f < _; ++f) {
                          const p = a.charCodeAt(f);
                          if (55296 <= p && p <= 56319) {
                            if (++f >= _) return ((this._interim = p), n);
                            const u = a.charCodeAt(f);
                            56320 <= u && u <= 57343
                              ? (c[n++] =
                                  1024 * (p - 55296) + u - 56320 + 65536)
                              : ((c[n++] = p), (c[n++] = u));
                          } else p !== 65279 && (c[n++] = p);
                        }
                        return n;
                      ...
                      decode(a, c) {
                        ...
                        if (this.interim[0]) {
                          let o = !1,
                            l = this.interim[0];
                          l &=
                            (224 & l) == 192 ? 31 : (240 & l) == 224 ? 15 : 7;
                          let v,
                            m = 0;
                          for (; (v = 63 & this.interim[++m]) && m < 4; )
                            ((l <<= 6), (l |= v));
                          const h =
                    ...
                    constructor() {
                      if (((this.version = '6'), !_)) {
                        ((_ = new Uint8Array(65536)),
                          ...
                          (_[9001] = 2),
                          (_[9002] = 2),
                          _.fill(2, 11904, 42192),
                          (_[12351] = 1),
                          _.fill(2, 44032, 55204),
                          _.fill(2, 63744, 64256),
                          _.fill(2, 65040, 65050),
                          _.fill(2, 65072, 65136),
                          _.fill(2, 65280, 65377),
                          _.fill(2, 65504, 65511));
                        for (let n = 0; n < a.length; ++n)
                          _.fill(0, a[n][0], a[n][1] + 1);
                      }
                    }
                    wcwidth(n) {
                      return n < 32
                ...
                5941: (I, r) => {
                  ...
                  ((r.parseColor = function (n) {
                    ...
                    if (d.indexOf('rgb:') === 0) {
                      ...
                      const f = a.exec(d);
                      if (f) {
                        const p = f[1] ? 15 : f[4] ? 255 : f[7] ? 4095 : 65535;
                        return [
                          Math.round(
                            (parseInt(f[1] || f[4] || f[7] || f[10], 16) / p) *
                              255,
                          ),
                          Math.round(
                            (parseInt(f[2] || f[5] || f[8] || f[11], 16) / p) *
                              255,
                          ),
                          Math.round(
                            (parseInt(f[3] || f[6] || f[9] || f[12], 16) / p) *
                              255,
                          ),
                        ];
                      }
                ...
                6351: (I, r, a) => {
                  ...
                  r.DcsParser = class {
                    ...
                    hook(p, u) {
                      if (
                        (this.reset(),
                        (this._ident = p),
                        (this._active = this._handlers[p] || d),
                        this._active.length)
                      )
                    ...
                    put(p, u, e) {
                      if (this._active.length)
                        for (let s = this._active.length - 1; s >= 0; s--)
                          this._active[s].put(p, u, e);
                      else
                        this._handlerFb(
                          this._ident,
                          'PUT',
                          (0, c.utf32ToString)(p, u, e),
                        );
                    }
                    unhook(p, u = !0) {
                      if (this._active.length) {
                  ...
                  (f.addParam(0),
                    (r.DcsHandler = class {
                      ...
                      hook(p) {
                        ((this._params =
                          p.length > 1 || p.params[0] ? p.clone() : f),
                          (this._data = ''),
                          (this._hitLimit = !1));
                      }
                      put(p, u, e) {
                        this._hitLimit ||
                          ((this._data += (0, c.utf32ToString)(p, u, e)),
                      ...
                      unhook(p) {
                        ...
                        if (this._hitLimit) u = !1;
                          ...
                          p &&
                          ((u = this._handler(this._data, this._params)),
                ...
                2015: (I, r, a) => {
                  ...
                  r.VT500_TRANSITION_TABLE = (function () {
                    const e = new f(4095),
                      s = Array.apply(null, Array(256)).map((m, h) => h),
                      t = (m, h) => s.slice(m, h),
                      i = t(32, 127),
                      o = t(0, 24);
                    ...
                    const l = t(0, 14);
                    let v;
                    for (v in (e.setDefault(1, 0), e.addMany(i, 0, 2, 0), l))
                      (e.addMany([24, 26, 153, 154], v, 3, 0),
                        e.addMany(t(128, 144), v, 3, 0),
                        e.addMany(t(144, 152), v, 3, 0),
                        e.add(156, v, 0, 0),
                        e.add(27, v, 11, 1),
                        e.add(157, v, 4, 8),
                        e.addMany([152, 158, 159], v, 0, 7),
                        e.add(155, v, 11, 3),
                        e.add(144, v, 11, 9));
                    return (
                      e.addMany(o, 0, 3, 0),
                      ...
                      e.add(127, 7, 0, 7),
                      e.add(91, 1, 11, 3),
                      e.addMany(t(64, 127), 3, 7, 0),
                      e.addMany(t(48, 60), 3, 8, 4),
                      e.addMany([60, 61, 62, 63], 3, 9, 4),
                      e.addMany(t(48, 60), 4, 8, 4),
                      e.addMany(t(64, 127), 4, 7, 0),
                      e.addMany([60, 61, 62, 63], 4, 0, 6),
                      e.addMany(t(32, 64), 6, 0, 6),
                      e.add(127, 6, 0, 6),
                      e.addMany(t(64, 127), 6, 0, 0),
                      e.addMany(t(32, 48), 3, 9, 5),
                      e.addMany(t(32, 48), 5, 9, 5),
                      e.addMany(t(48, 64), 5, 0, 6),
                      e.addMany(t(64, 127), 5, 7, 0),
                      e.addMany(t(32, 48), 4, 9, 5),
                      e.addMany(t(32, 48), 1, 9, 2),
                      e.addMany(t(32, 48), 2, 9, 2),
                      e.addMany(t(48, 127), 2, 10, 0),
                      e.addMany(t(48, 80), 1, 10, 0),
                      e.addMany(t(81, 88), 1, 10, 0),
                      e.addMany([89, 90, 92], 1, 10, 0),
                      e.addMany(t(96, 127), 1, 10, 0),
                      e.add(80, 1, 11, 9),
                      e.addMany(o, 9, 0, 9),
                      e.add(127, 9, 0, 9),
                      e.addMany(t(28, 32), 9, 0, 9),
                      e.addMany(t(32, 48), 9, 9, 12),
                      e.addMany(t(48, 60), 9, 8, 10),
                      e.addMany([60, 61, 62, 63], 9, 9, 10),
                      e.addMany(o, 11, 0, 11),
                      e.addMany(t(32, 128), 11, 0, 11),
                      e.addMany(t(28, 32), 11, 0, 11),
                      e.addMany(o, 10, 0, 10),
                      e.add(127, 10, 0, 10),
                      e.addMany(t(28, 32), 10, 0, 10),
                      e.addMany(t(48, 60), 10, 8, 10),
                      e.addMany([60, 61, 62, 63], 10, 0, 11),
                      e.addMany(t(32, 48), 10, 9, 12),
                      e.addMany(o, 12, 0, 12),
                      e.add(127, 12, 0, 12),
                      e.addMany(t(28, 32), 12, 0, 12),
                      e.addMany(t(32, 48), 12, 9, 12),
                      e.addMany(t(48, 64), 12, 0, 11),
                      e.addMany(t(64, 127), 12, 12, 13),
                      e.addMany(t(64, 127), 10, 12, 13),
                      e.addMany(t(64, 127), 9, 12, 13),
                  ...
                  class u extends c.Disposable {
                    ...
                    identToString(s) {
                      const t = [];
                      for (; s; )
                        (t.push(String.fromCharCode(255 & s)), (s >>= 8));
                          ...
                          switch (this._parseStack.state) {
                            case 3:
                              if (i === !1 && g > -1) {
                                for (
                                  ;
                                  g >= 0 &&
                                  ((o = h[g](this._params)), o !== !0);
                                  g--
                                )
                                  if (o instanceof Promise)
                                    return (
                                      (this._parseStack.handlerPos = g),
                                      o
                                    );
                              }
                              this._parseStack.handlers = [];
                            ...
                            case 6:
                              if (
                                ...
                                return o;
                              (l === 27 && (this._parseStack.transition |= 1),
                                this._params.reset(),
                                this._params.addParam(0),
                                (this._collect = 0));
                              break;
                      ...
                      for (let h = m; h < t; ++h) {
                        switch (
                          ...
                          case 2:
                            ...
                            break;
                          case 3:
                            (this._executeHandlers[l]
                              ? this._executeHandlers[l]()
                              : this._executeHandlerFb(l),
                              (this.precedingCodepoint = 0));
                            break;
                          case 0:
                            break;
                          ...
                          case 7:
                            const g =
                              this._csiHandlers[(this._collect << 8) | l];
                            let b = g ? g.length - 1 : -1;
                            for (
                              ;
                              b >= 0 && ((o = g[b](this._params)), o !== !0);
                              b--
                            )
                              if (o instanceof Promise)
                                return (this._preserveStack(3, g, b, v, h), o);
                            (b < 0 &&
                              this._csiHandlerFb(
                                (this._collect << 8) | l,
                                this._params,
                          ...
                          case 10:
                            const L =
                              this._escHandlers[(this._collect << 8) | l];
                            let y = L ? L.length - 1 : -1;
                            for (; y >= 0 && ((o = L[y]()), o !== !0); y--)
                              if (o instanceof Promise)
                                return (this._preserveStack(4, L, y, v, h), o);
                            (y < 0 &&
                              this._escHandlerFb((this._collect << 8) | l),
                              (this.precedingCodepoint = 0));
                            break;
                          case 11:
                            (this._params.reset(),
                          ...
                          case 14:
                            if (
                              ...
                              return (this._preserveStack(6, [], 0, v, h), o);
                            (l === 27 && (v |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                          ...
                          case 6:
                            if (
                              ((o = this._oscParser.end(l !== 24 && l !== 26)),
                              o)
                            )
                              return (this._preserveStack(5, [], 0, v, h), o);
                            (l === 27 && (v |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                ...
                6242: (I, r, a) => {
                  ...
                  ((r.OscParser = class {
                    ...
                    _put(d, f, p) {
                      if (this._active.length)
                        for (let u = this._active.length - 1; u >= 0; u--)
                          this._active[u].put(d, f, p);
                      else
                        this._handlerFb(
                          this._id,
                          'PUT',
                          (0, _.utf32ToString)(d, f, p),
                        );
                    }
                    start() {
                        ...
                        if (this._state === 1)
                          for (; f < p; ) {
                            ...
                            (this._id === -1 && (this._id = 0),
                              (this._id = 10 * this._id + u - 48));
                          }
                        this._state === 2 && p - f > 0 && this._put(d, f, p);
                      }
                    }
                    end(d, f = !0) {
                      if (this._state !== 0) {
                        if (this._state !== 3)
                          if (
                            ...
                            let p = !1,
                              u = this._active.length - 1,
                              e = !1;
                            if (
                              (this._stack.paused &&
                                ((u = this._stack.loopPosition - 1),
                                (p = f),
                              ...
                              for (
                                ;
                                u >= 0 &&
                                ((p = this._active[u].end(d)), p !== !0);
                                u--
                              )
                                if (p instanceof Promise)
                                  return (
                                    (this._stack.paused = !0),
                                    (this._stack.loopPosition = u),
                                    (this._stack.fallThrough = !1),
                                    p
                                  );
                              u--;
                    ...
                    (r.OscHandler = class {
                      ...
                      put(d, f, p) {
                        this._hitLimit ||
                          ((this._data += (0, _.utf32ToString)(d, f, p)),
                          this._data.length > c.PAYLOAD_LIMIT &&
                            ((this._data = ''), (this._hitLimit = !0)));
                      }
                      end(d) {
                        let f = !1;
                  ...
                  class c {
                    ...
                    toArray() {
                      ...
                      for (let d = 0; d < this.length; ++d) {
                        ...
                        const f = this._subParamsIdx[d] >> 8,
                          p = 255 & this._subParamsIdx[d];
                        p - f > 0 &&
                          n.push(
                            Array.prototype.slice.call(this._subParams, f, p),
                          );
                      }
                      return n;
                    }
                    ...
                    getSubParamsAll() {
                      ...
                      for (let d = 0; d < this.length; ++d) {
                        const f = this._subParamsIdx[d] >> 8,
                          p = 255 & this._subParamsIdx[d];
                        p - f > 0 && (n[d] = this._subParams.slice(f, p));
                      }
                      return n;
                    }
                    addDigit(n) {
                      ...
                      if (
                        ...
                        return;
                      const f = this._digitIsSub
                          ? this._subParams
                          : this.params,
                        p = f[d - 1];
                      f[d - 1] = ~p ? Math.min(10 * p + n, a) : n;
                    }
                  }
                  r.Params = c;
                },
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.AddonManager = class {
                      ...
                      loadAddon(a, c) {
                        ...
                        (this._addons.push(_),
                          (c.dispose = () => this._wrappedAddonDispose(_)),
                          c.activate(a));
                      }
                    ...
                    getCell(_, n) {
                      if (!(_ < 0 || _ >= this._line.length))
                        return n
                          ...
                          : this._line.loadCell(_, new c.CellData());
                    }
                  ...
                  class d extends n.Disposable {
                    constructor(p) {
                      (super(),
                        ...
                        (this._normal = new c.BufferApiView(
                          this._core.buffers.normal,
                          'normal',
                        )),
                        (this._alternate = new c.BufferApiView(
                ...
                744: function (I, r, a) {
                  ...
                  let u = (r.BufferService = class extends d.Disposable {
                    get buffer() {
                      return this.buffers.active;
                    }
                    constructor(e) {
                      (super(),
                        ...
                        (this.buffers = this.register(
                          new f.BufferSet(e, this),
                        )));
                    }
                    resize(e, s) {
                      ((this.cols = e),
                        (this.rows = s),
                        this.buffers.resize(e, s),
                        this._onResize.fire({ cols: e, rows: s }));
                    }
                    reset() {
                    ...
                    scroll(e, s = !1) {
                      ...
                      ((i = this._cachedBlankLine),
                        (i &&
                          ...
                          i.getFg(0) === e.fg &&
                          i.getBg(0) === e.bg) ||
                          ((i = t.getBlankLine(e, s)),
                          (this._cachedBlankLine = i)),
                        (i.isWrapped = s));
                      const o = t.ybase + t.scrollTop,
                        l = t.ybase + t.scrollBottom;
                      if (t.scrollTop === 0) {
                        const v = t.lines.isFull;
                        (l === t.lines.length - 1
                          ? v
                            ? t.lines.recycle().copyFrom(i)
                            : t.lines.push(i.clone())
                          : t.lines.splice(l + 1, 0, i.clone()),
                          v
                            ? this.isUserScrolling &&
                              (t.ydisp = Math.max(t.ydisp - 1, 0))
                            : (t.ybase++, this.isUserScrolling || t.ydisp++));
                      } else {
                        const v = l - o + 1;
                        (t.lines.shiftElements(o + 1, v - 1, -1),
                          t.lines.set(l, i.clone()));
                      }
                      (this.isUserScrolling || (t.ydisp = t.ybase),
                        this._onScroll.fire(t.ydisp));
                    }
                    scrollLines(e, s, t) {
                      const i = this.buffer;
                      if (e < 0) {
                      ...
                      ((i.ydisp = Math.max(Math.min(i.ydisp + e, i.ybase), 0)),
                        o !== i.ydisp && (s || this._onScroll.fire(i.ydisp)));
                    }
                  });
                  r.BufferService = u = c([_(0, p.IOptionsService)], u);
                },
                7994: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                ...
                1753: function (I, r, a) {
                    ...
                    p = {
                      ...
                      X10: {
                        ...
                        restrict: (i) =>
                          i.button !== 4 &&
                          i.action === 1 &&
                          ((i.ctrl = !1), (i.alt = !1), (i.shift = !1), !0),
                      },
                      VT200: { events: 19, restrict: (i) => i.action !== 32 },
                      DRAG: {
                        events: 23,
                        restrict: (i) => i.action !== 32 || i.button !== 3,
                      },
                      ANY: { events: 31, restrict: (i) => !0 },
                    };
                  function u(i, o) {
                    let l =
                      (i.ctrl ? 16 : 0) | (i.shift ? 4 : 0) | (i.alt ? 8 : 0);
                    return (
                      i.button === 4
                        ? ((l |= 64), (l |= i.action))
                        : ((l |= 3 & i.button),
                  ...
                  let t = (r.CoreMouseService = class extends f.Disposable {
                    constructor(i, o) {
                      ...
                      for (const l of Object.keys(p)) this.addProtocol(l, p[l]);
                    ...
                    set activeProtocol(i) {
                      ...
                      ((this._activeProtocol = i),
                        this._onProtocolChange.fire(this._protocols[i].events));
                    }
                    get activeEncoding() {
                    ...
                    triggerMouseEvent(i) {
                      if (
                        i.col < 0 ||
                        i.col >= this._bufferService.cols ||
                        i.row < 0 ||
                        i.row >= this._bufferService.rows ||
                        (i.button === 4 && i.action === 32) ||
                        (i.button === 3 && i.action !== 32) ||
                        (i.button !== 4 &&
                          (i.action === 2 || i.action === 3)) ||
                        (i.col++,
                        i.row++,
                        i.action === 32 &&
                          this._lastEvent &&
                        ...
                        !this._protocols[this._activeProtocol].restrict(i)
                      )
                        return !1;
                ...
                6975: function (I, r, a) {
                  var c =
                      ...
                      function (t, i, o, l) {
                        ...
                        if (
                          ...
                          h = Reflect.decorate(t, i, o, l);
                        else
                          for (var g = t.length - 1; g >= 0; g--)
                            (v = t[g]) &&
                              (h =
                                (m < 3 ? v(h) : m > 3 ? v(i, o, h) : v(i, o)) ||
                                h);
                        return (
                          m > 3 && h && Object.defineProperty(i, o, h),
                          h
                        );
                      },
                    _ =
                  ...
                  let s = (r.CoreService = class extends f.Disposable {
                    constructor(t, i, o) {
                      (super(),
                        (this._bufferService = t),
                        (this._logService = i),
                        ...
                        (this.modes = (0, n.clone)(u)),
                        (this.decPrivateModes = (0, n.clone)(e)));
                    }
                    reset() {
                      ((this.modes = (0, n.clone)(u)),
                        (this.decPrivateModes = (0, n.clone)(e)));
                    ...
                    triggerDataEvent(t, i = !1) {
                      ...
                      (i &&
                        ...
                        i && this._onUserInput.fire(),
                        this._logService.debug(`sending data "${t}"`, () =>
                          t.split('').map((l) => l.charCodeAt(0)),
                        ),
                        this._onData.fire(t));
                    }
                    triggerBinaryEvent(t) {
                      this._optionsService.rawOptions.disableStdin ||
                        (this._logService.debug(`sending binary "${t}"`, () =>
                          t.split('').map((i) => i.charCodeAt(0)),
                        ),
                        this._onBinary.fire(t));
                    }
                  });
                  r.CoreService = s = c(
                    [
                      _(0, p.IBufferService),
                      _(1, p.ILogService),
                      _(2, p.IOptionsService),
                    ],
                    s,
                ...
                9074: (I, r, a) => {
                  ...
                  class u extends n.Disposable {
                    ...
                    constructor() {
                      (super(),
                        (this._decorations = new d.SortedList(
                          (t) => t?.marker.line,
                        )),
                    ...
                    registerDecoration(t) {
                      ...
                      if (i) {
                        ...
                        (i.onDispose(() => {
                          i &&
                            (this._decorations.delete(i) &&
                              this._onDecorationRemoved.fire(i),
                            o.dispose());
                        }),
                          this._decorations.insert(i),
                          this._onDecorationRegistered.fire(i));
                      }
                      return i;
                    }
                    reset() {
                    ...
                    *getDecorationsAtCell(t, i, o) {
                      ...
                      let h = 0,
                        g = 0;
                      for (const b of this._decorations.getKeyIterator(i))
                        ((h =
                          (l = b.options.x) !== null && l !== void 0 ? l : 0),
                          (g =
                            h +
                            ((v = b.options.width) !== null && v !== void 0
                              ? v
                              : 1)),
                          t >= h &&
                            t < g &&
                            (!o ||
                              ((m = b.options.layer) !== null && m !== void 0
                                ? m
                                : 'bottom') === o) &&
                            (yield b));
                    }
                    forEachDecorationAtCell(t, i, o, l) {
                      this._decorations.forEachByKey(i, (v) => {
                        var m, h, g;
                        ((f =
                          (m = v.options.x) !== null && m !== void 0 ? m : 0),
                          (p =
                            f +
                            ((h = v.options.width) !== null && h !== void 0
                              ? h
                              : 1)),
                          t >= f &&
                            t < p &&
                            (!o ||
                              ((g = v.options.layer) !== null && g !== void 0
                                ? g
                                : 'bottom') === o) &&
                            l(v));
                      });
                ...
                4348: (I, r, a) => {
                  ...
                  class n {
                    constructor(...f) {
                      ...
                      for (const [p, u] of f) this.set(p, u);
                    }
                    set(f, p) {
                      const u = this._entries.get(f);
                      return (this._entries.set(f, p), u);
                    }
                    forEach(f) {
                      for (const [p, u] of this._entries.entries()) f(p, u);
                    }
                    has(f) {
                  ...
                  ((r.ServiceCollection = n),
                    (r.InstantiationService = class {
                      ...
                      createInstance(d, ...f) {
                        const p = (0, _.getServiceDependencies)(d).sort(
                            (s, t) => s.index - t.index,
                          ),
                          u = [];
                        for (const s of p) {
                        ...
                        const e = p.length > 0 ? p[0].index : f.length;
                        if (f.length !== e)
                          throw new Error(
                            `[createInstance] First service dependency of ${d.name} at position ${e + 1} conflicts with ${f.length} static arguments`,
                          );
                        return new d(...f, ...u);
                      }
                    }));
                ...
                7866: function (I, r, a) {
                  ...
                  let p,
                    u = (r.LogService = class extends n.Disposable {
                      get logLevel() {
                      ...
                      _updateLogLevel() {
                        this._logLevel =
                          f[this._optionsService.rawOptions.logLevel];
                      }
                      _evalLazyOptionalParams(e) {
                        for (let s = 0; s < e.length; s++)
                          typeof e[s] == 'function' && (e[s] = e[s]());
                      }
                      _log(e, s, t) {
                        (this._evalLazyOptionalParams(t),
                          e.call(
                            console,
                      ...
                      trace(e, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.TRACE &&
                          this._log(
                            (i =
                              (t = this._optionsService.options.logger) ===
                                null || t === void 0
                                ? void 0
                                : t.trace.bind(
                                    this._optionsService.options.logger,
                  ...
                  ((r.LogService = u = c([_(0, d.IOptionsService)], u)),
                    (r.setTraceLogger = function (e) {
                      p = e;
                    }),
                    (r.traceCall = function (e, s, t) {
                      ...
                      const i = t.value;
                      t.value = function (...o) {
                        if (p.logLevel !== d.LogLevelEnum.TRACE)
                          return i.apply(this, o);
                        p.trace(
                          `GlyphRenderer#${i.name}(${o.map((v) => JSON.stringify(v)).join(', ')})`,
                        );
                        const l = i.apply(this, o);
                        return (
                          p.trace(`GlyphRenderer#${i.name} return`, l),
                          l
                        );
                      };
                    }));
                    ...
                    constructor(u) {
                      ...
                      for (const s in u)
                        if (s in e)
                          try {
                            const t = u[s];
                            e[s] = this._sanitizeAndValidateOption(s, t);
                          } catch (t) {
                            console.error(t);
                          }
                      ((this.rawOptions = e),
                    ...
                    _setupOptions() {
                      const u = (s) => {
                        ...
                        e = (s, t) => {
                          if (!(s in r.DEFAULT_OPTIONS))
                            throw new Error(`No option with key "${s}"`);
                          ((t = this._sanitizeAndValidateOption(s, t)),
                            this.rawOptions[s] !== t &&
                              ((this.rawOptions[s] = t),
                              this._onOptionChange.fire(s)));
                        };
                      for (const s in this.rawOptions) {
                        ...
                        Object.defineProperty(this.options, s, t);
                      }
                    }
                    _sanitizeAndValidateOption(u, e) {
                      switch (u) {
                        ...
                        case 'fontWeightBold':
                          ...
                          e = d.includes(e) ? e : r.DEFAULT_OPTIONS[u];
                          break;
                        case 'cursorWidth':
                          e = Math.floor(e);
                        case 'lineHeight':
                        case 'tabStopWidth':
                          if (e < 1)
                            throw new Error(
                              `${u} cannot be less than 1, value: ${e}`,
                            );
                          break;
                        case 'minimumContrastRatio':
                          e = Math.max(
                            1,
                            Math.min(21, Math.round(10 * e) / 10),
                          );
                          break;
                        case 'scrollback':
                          if ((e = Math.min(e, 4294967295)) < 0)
                            throw new Error(
                              `${u} cannot be less than 0, value: ${e}`,
                            );
                          break;
                        ...
                        case 'scrollSensitivity':
                          if (e <= 0)
                            throw new Error(
                              `${u} cannot be less than or equal to 0, value: ${e}`,
                            );
                          break;
                        case 'rows':
                        case 'cols':
                ...
                2660: function (I, r, a) {
                        ...
                        var s,
                          ...
                          i =
                            t < 3
                              ? p
                              : e === null
                                ? (e = Object.getOwnPropertyDescriptor(p, u))
                                : e;
                        if (
                          typeof Reflect == 'object' &&
                          typeof Reflect.decorate == 'function'
                        )
                          i = Reflect.decorate(f, p, u, e);
                        else
                          for (var o = f.length - 1; o >= 0; o--)
                            (s = f[o]) &&
                              (i =
                                (t < 3 ? s(i) : t > 3 ? s(p, u, i) : s(p, u)) ||
                                i);
                        return (
                          t > 3 && i && Object.defineProperty(p, u, i),
                          i
                        );
                      },
                    _ =
                  ...
                  let d = (r.OscLinkService = class {
                    ...
                    registerLink(f) {
                      ...
                      if (f.id === void 0) {
                        const o = p.addMarker(p.ybase + p.y),
                          l = { data: f, id: this._nextId++, lines: [o] };
                        return (
                          o.onDispose(() => this._removeMarkerFromLink(l, o)),
                          this._dataByLinkId.set(l.id, l),
                          l.id
                        );
                      }
                      const u = f,
                        e = this._getEntryIdKey(u),
                        s = this._entriesWithId.get(e);
                      if (s)
                        return (this.addLineToLink(s.id, p.ybase + p.y), s.id);
                      const t = p.addMarker(p.ybase + p.y),
                        i = {
                          id: this._nextId++,
                          key: this._getEntryIdKey(u),
                          data: u,
                          lines: [t],
                        };
                      return (
                        t.onDispose(() => this._removeMarkerFromLink(i, t)),
                        this._entriesWithId.set(i.key, i),
                        this._dataByLinkId.set(i.id, i),
                        i.id
                      );
                    }
                    addLineToLink(f, p) {
                      const u = this._dataByLinkId.get(f);
                      if (u && u.lines.every((e) => e.line !== p)) {
                        const e = this._bufferService.buffer.addMarker(p);
                        (u.lines.push(e),
                          e.onDispose(() => this._removeMarkerFromLink(u, e)));
                      }
                    }
                    getLinkData(f) {
                      var p;
                      return (p = this._dataByLinkId.get(f)) === null ||
                        p === void 0
                        ? void 0
                        : p.data;
                    }
                    ...
                    _removeMarkerFromLink(f, p) {
                      const u = f.lines.indexOf(p);
                      u !== -1 &&
                        (f.lines.splice(u, 1),
                        f.lines.length === 0 &&
                          (f.data.id !== void 0 &&
                            this._entriesWithId.delete(f.key),
                          this._dataByLinkId.delete(f.id)));
                    }
                  });
                  r.OscLinkService = d = c([_(0, n.IBufferService)], d);
                },
                8343: (I, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    (r.createDecorator =
                  ...
                  ((r.serviceRegistry = new Map()),
                    ...
                    (r.createDecorator = function (_) {
                      ...
                      const n = function (d, f, p) {
                        ...
                        (function (u, e, s) {
                          e[a] === e
                            ? e[c].push({ id: u, index: s })
                            : ((e[c] = [{ id: u, index: s }]), (e[a] = e));
                        })(n, d, p);
                      };
                      return (
                        (n.toString = () => _),
                ...
                2585: (I, r, a) => {
                  ...
                  const c = a(8343);
                  var _;
                  ((r.IBufferService = (0, c.createDecorator)('BufferService')),
                    (r.ICoreMouseService = (0, c.createDecorator)(
                      'CoreMouseService',
                    )),
                    (r.ICoreService = (0, c.createDecorator)('CoreService')),
                    (r.ICharsetService = (0, c.createDecorator)(
                      'CharsetService',
                    )),
                    (r.IInstantiationService = (0, c.createDecorator)(
                    ...
                    (r.ILogService = (0, c.createDecorator)('LogService')),
                    (r.IOptionsService = (0, c.createDecorator)(
                      'OptionsService',
                    )),
                    (r.IOscLinkService = (0, c.createDecorator)(
                      'OscLinkService',
                    )),
                    (r.IUnicodeService = (0, c.createDecorator)(
                      'UnicodeService',
                    )),
                    (r.IDecorationService = (0, c.createDecorator)(
                      'DecorationService',
                    )));
                },
                1480: (I, r, a) => {
                  ...
                  r.UnicodeService = class {
                    constructor() {
                      ...
                      (this.register(n),
                        (this._active = n.version),
                        (this._activeProvider = n));
                    }
                    dispose() {
                    ...
                    set activeVersion(n) {
                      ...
                      ((this._active = n),
                        (this._activeProvider = this._providers[n]),
                        this._onChange.fire(n));
                    }
                    register(n) {
                    ...
                    getStringCellWidth(n) {
                      ...
                      const f = n.length;
                      for (let p = 0; p < f; ++p) {
                        let u = n.charCodeAt(p);
                        if (55296 <= u && u <= 56319) {
                          if (++p >= f) return d + this.wcwidth(u);
                          const e = n.charCodeAt(p);
                          56320 <= e && e <= 57343
                            ? (u = 1024 * (u - 55296) + e - 56320 + 65536)
                            : (d += this.wcwidth(e));
                        }
                        d += this.wcwidth(u);
                      }
            ...
            function q(I) {
              ...
              var a = (J[I] = { exports: {} });
              return (te[I].call(a.exports, a, a.exports, q), a.exports);
            }
            var Z = {};
            return (
              (() => {
                ...
                class u extends c.Disposable {
                  constructor(s) {
                    ...
                    const t = (o) => this._core.options[o],
                      i = (o, l) => {
                        (this._checkReadonlyOptions(o),
                          (this._core.options[o] = l));
                      };
                  ...
                  _checkReadonlyOptions(s) {
                    if (p.includes(s))
                      throw new Error(
                        `Option "${s}" can only be set in the constructor`,
                      );
                  }
                  _checkProposedApi() {
                  ...
                  registerCharacterJoiner(s) {
                    return (
                      this._checkProposedApi(),
                      this._core.registerCharacterJoiner(s)
                    );
                  }
                  deregisterCharacterJoiner(s) {
                    (this._checkProposedApi(),
                      this._core.deregisterCharacterJoiner(s));
                  }
                  registerMarker(s = 0) {
                    return (
                      this._verifyIntegers(s),
                      this._core.registerMarker(s)
                    );
                  }
                  registerDecoration(s) {
                    var t, i, o;
                    return (
                      ...
                      this._verifyPositiveIntegers(
                        (t = s.x) !== null && t !== void 0 ? t : 0,
                        (i = s.width) !== null && i !== void 0 ? i : 0,
                        (o = s.height) !== null && o !== void 0 ? o : 0,
                      ),
              ...
              (() => {
                ...
                (Object.defineProperty(J, '__esModule', { value: !0 }),
                  ...
                  (J.FitAddon = class {
                    ...
                    dispose() {}
                    fit() {
                      const q = this.proposeDimensions();
                      if (
                        !q ||
                        !this._terminal ||
                        isNaN(q.cols) ||
                      ...
                      (this._terminal.rows === q.rows &&
                        this._terminal.cols === q.cols) ||
                        (Z._renderService.clear(),
                        this._terminal.resize(q.cols, q.rows));
                    }
                    proposeDimensions() {
                      if (
                        !this._terminal ||
                      ...
                      const q = this._terminal._core,
                        Z = q._renderService.dimensions;
                      if (Z.css.cell.width === 0 || Z.css.cell.height === 0)
                        return;
                      const I =
                          this._terminal.options.scrollback === 0
                            ? 0
                            : q.viewport.scrollBarWidth,
                        ...
                        d =
                          ...
                          I;
                      return {
                        cols: Math.max(2, Math.floor(d / Z.css.cell.width)),
