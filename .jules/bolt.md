...
## 2026-06-09 - Zustand Selectors Mapping Static Arrays
**Learning:** Zustand selectors that map over large static arrays on every state change cause significant allocation overhead.
**Action:** Always extract static array mapping or initialization logic outside of the selector definition.
